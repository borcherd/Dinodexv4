(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2704],
  {
    ...
    22398: (e) => {
      e.exports = { scrollWrap: 'scrollWrap-kVyuzKgN' };
    },
    28989: (e) => {
      e.exports = {
        container: 'container-Z9KGRKmf',
        separator: 'separator-Z9KGRKmf',
        section: 'section-Z9KGRKmf',
      };
    },
    45442: (e) => {
      e.exports = {
        action: 'action-BDFVv8gk',
        hovered: 'hovered-BDFVv8gk',
        active: 'active-BDFVv8gk',
        label: 'label-BDFVv8gk',
        description: 'description-BDFVv8gk',
        selected: 'selected-BDFVv8gk',
        small: 'small-BDFVv8gk',
        withDescription: 'withDescription-BDFVv8gk',
        action__favoriteIcon: 'action__favoriteIcon-BDFVv8gk',
        action__favoriteIcon_active: 'action__favoriteIcon_active-BDFVv8gk',
        labelAndDescription: 'labelAndDescription-BDFVv8gk',
        icon: 'icon-BDFVv8gk',
        fakeIcon: 'fakeIcon-BDFVv8gk',
        highlighted: 'highlighted-BDFVv8gk',
      };
    },
    86620: (e) => {
      e.exports = {
        menu: 'menu-ByJd0Z1Y',
        withDescriptions: 'withDescriptions-ByJd0Z1Y',
        header: 'header-ByJd0Z1Y',
        title: 'title-ByJd0Z1Y',
        container: 'container-ByJd0Z1Y',
        icon: 'icon-ByJd0Z1Y',
        clear: 'clear-ByJd0Z1Y',
        input: 'input-ByJd0Z1Y',
        highlighted: 'highlighted-ByJd0Z1Y',
        active: 'active-ByJd0Z1Y',
        section: 'section-ByJd0Z1Y',
      };
    },
    82730: (e) => {
      e.exports = {};
      ...
      class k extends r.PureComponent {
        ...
        render() {
          const {
            ...
            K = 'after' !== m ? v : void 0,
            V = 'after' === m ? v : void 0,
            W = 'string' == typeof i ? i : O || '',
            j = (0, _.mergeRefs)([this._handleReference, z]);
          return r.createElement(
            h.MatchMedia,
    ...
    69654: (e, t, n) => {
      ...
      function u(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            'div',
            { className: i()(c.inputContainer, u && c.withCancel) },
    ...
    71834: (e, t, n) => {
        ...
        function (e) {
          ...
          return r.createElement(
            ...
            m &&
              (void 0 !== n
                ? r.createElement(_, {
                    logoUrl: n,
                    size: f ? 'xsmall' : 'xxsmall',
                    className: h()(S.icon, C),
                  })
                : r.createElement('span', { className: h()(S.fakeIcon, C) })),
            r.createElement(
              'div',
              { className: h()(S.labelAndDescription, C) },
              r.createElement('span', { className: h()(S.label, C) }, w(t)),
              f && r.createElement('br', null),
              f &&
                r.createElement(
                  'span',
                  { className: h()(S.description, C) },
                  a ? w(a) : '',
                ),
            ),
            void 0 !== v &&
              r.createElement(
                ...
                {
                  className: h()(
                    S.action__favoriteIcon,
                    v && S.action__favoriteIcon_active,
                  ),
                },
          ...
          function w(e) {
            return r.createElement(b.HighlightedText, {
              ...
              rules: o,
              queryString: i,
              className: h()(c && S.highlighted, c && S.active),
            });
          }
        },
        (e, t) =>
      ...
      var k = n(48471),
        ...
        D = n(86620),
        A = n(22398);
      const N = (0, g.mergeThemes)(v.DEFAULT_MENU_THEME, A);
      function R(e) {
        const {
            title: t,
            sections: o,
        ...
        return r.createElement(
          m.PopupMenu,
          {
            ..._,
            onClose: i,
            className: h()(D.menu, g && D.withDescriptions),
            theme: N,
            maxHeight: g ? 313 : 280,
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(f.Icon, { icon: k, className: D.icon }),
      ...
      function L(e) {
        ...
        return r.createElement(B.AdaptivePopupDialog, {
          title: t,
          onClose: o,
          render: function () {
            return r.createElement(
              r.Fragment,
              null,
              r.createElement(I.DialogSearch, {
                placeholder: p.t(null, void 0, n(52298)),
                onChange: v,
                reference: h,
              }),
      ...
      function P(e) {
        ...
        return r.createElement(
          ...
          (e) =>
            e
              ? r.createElement(L, { ...n, ...y })
              : r.createElement(R, {
                  ...n,
                  ...y,
                  position: (0, u.getPopupPositioner)(t, O),
                  doNotCloseOn: t,
                }),
        );
        function C() {
    ...
    95257: (e, t) => {
      ...
      function k(e, t, r) {
        ...
        if (null != t)
          ...
          t))
            b.call(t, o) && !w.hasOwnProperty(o) && (i[o] = t[o]);
      ...
      function l(e) {
        return r.createElement(
          ...
          r.createElement(
            'div',
            {
              className: i()(e.className, s.summary),
              onClick: function () {
