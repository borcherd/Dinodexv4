  ...
  [2182],
  {
          ...
          (o.disableBodyScroll = function (o, i) {
            if (n) {
              ...
              (h = i),
                setTimeout(function () {
                  if (void 0 === r) {
                    var o = !!h && !0 === h.reserveScrollBarGap,
                      e =
                        window.innerWidth -
              ...
              var m = { targetElement: o, options: i || {} };
              a = [].concat(e(a), [m]);
            }
            var h;
          }),
    ...
    71758: (o, e, l) => {
      ...
      const r = (0, c.humanReadableModifiers)(c.Modifiers.Shift, !1),
        ...
        m = { keys: [r], text: i.t(null, void 0, l(68125)) },
        h = { keys: [r], text: i.t(null, void 0, l(81591)) },
        v = {
    ...
    65383: (o, e, l) => {
      'use strict';
      l.d(e, { LinetoolsFavoritesStore: () => c });
      var i = l(26867),
        n = l.n(i),
        a = l(56840);
      ...
      !(function (o) {
        function e() {
          ...
          let s = !1;
          const c = Boolean(
              void 0 === (0, a.getValue)('chart.favoriteDrawings'),
            ),
        ...
        function i(e) {
          ...
          null !== o.tweetToolPosition &&
            ...
            (0, a.setJSON)('chart.favoriteDrawings', l, e);
        }
        (o.favorites = []),
          (o.favoritesSynced = new (n())()),
          ...
          (o.saveFavorites = i),
          e(),
          a.onSync.subscribe(null, e);
      })(s || (s = {})),
        (function (o) {
          function e(o) {
            return s.isValidLineToolName(o);
          }
          function l() {
            return s.favorites.length;
          }
          function i(o) {
            return -1 !== s.favoriteIndex(o);
          }
          (o.favoriteAdded = new (n())()),
            (o.favoriteRemoved = new (n())()),
            (o.favoriteMoved = new (n())()),
            (o.favoritesSynced = s.favoritesSynced),
            ...
            (o.favorite = function (o) {
              return o < 0 || o >= l() ? '' : s.favorites[o];
            }),
            (o.addFavorite = function (l, n) {
              return (
                !(i(l) || !e(l)) &&
                (s.favorites.push(l),
                s.saveFavorites(n),
            ...
            (o.removeFavorite = function (e, l) {
              const i = s.favoriteIndex(e);
              if (-1 === i) return !1;
              s.favorites.splice(i, 1);
              const n = s.tweetToolPosition;
              return (
                null !== n && n > i && (s.tweetToolPosition = n - 1),
                s.saveFavorites(l),
            ...
            (o.moveFavorite = function (i, n, a) {
              ...
              const t = s.favoriteIndex(i);
              if (-1 === t || n === t) return !1;
              let c = s.tweetToolPosition;
              return (
                null !== c &&
                  (t < c && n > c ? c-- : n < c && t > c && c++,
                  (s.tweetToolPosition = c)),
                s.favorites.splice(t, 1),
                s.favorites.splice(n, 0, i),
                s.saveFavorites(a),
                o.favoriteMoved.fire(i, t, n),
                !0
              );
            });
        })(c || (c = {}));
