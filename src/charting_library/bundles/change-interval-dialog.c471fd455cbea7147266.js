(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2077],
  {
    ...
    67029: (e, t, n) => {
      'use strict';
      n.d(t, { ControlSkeleton: () => y, InputClasses: () => h });
      var r = n(50959),
        o = n(97754),
        i = n(50151),
        a = n(38528),
      ...
      function m(e, t, n, r) {
        const {
          ...
          b = f(null != i ? i : (0, u.getGroupCellRemoveRoundBorders)(n));
        return o(
          d().container,
          d()[`intent-${s}`],
          d()[`border-${l}`],
      ...
      function p(e, t) {
        const { highlight: n, highlightRemoveRoundBorder: r } = e;
        if (!n) return d().highlight;
        const i = f(null != r ? r : (0, u.getGroupCellRemoveRoundBorders)(t));
      ...
      function v(e, t) {
        const {
          ...
          } = e,
          {
            isGrouped: _,
            cellState: C,
            disablePositionAdjustment: E = !1,
          } = (0, r.useContext)(l.ControlGroupContext),
          W = (function (e, t = null, n) {
        ...
        return r.createElement(
          ...
          k,
          S,
          r.createElement('span', { className: p(e, C) }),
        );
      }
    ...
    31261: (e, t, n) => {
      ...
      function y(e) {
        ...
        const {
          ...
          w = (0, a.createSafeMulticastEventHandler)(
            b.onFocus,
            function (e) {
              n && !k.current && (0, s.selectAllContent)(e.currentTarget);
            },
            i,
          ),
          _ = (0, a.createSafeMulticastEventHandler)(b.onBlur, f),
          C = (0, r.useCallback)(
            (e) => {
              (h.current = e),
                m &&
        ...
        return r.createElement(v, {
          ...
          onContainerFocus: function (e) {
            g.current === e.target && null !== h.current && h.current.focus();
          },
          onFocus: w,
          onBlur: _,
          reference: C,
    ...
    95257: (e, t) => {
      ...
      (D.constructor = b), h(D, v.prototype), (D.isPureReactComponent = !0);
      var M = Array.isArray,
      ...
      function w(e, t, r) {
        ...
        if (null != t)
          ...
          t))
            k.call(t, o) && !H.hasOwnProperty(o) && (i[o] = t[o]);
    ...
    73501: (e, t, n) => {
      'use strict';
      n.r(t), n.d(t, { showChangeIntervalDialog: () => k });
      var r = n(50959),
        o = n(962),
        i = n(97754),
        a = n.n(i),
      ...
      function D(e) {
        const { initVal: t, selectOnInit: o, onClose: i } = e,
          ...
          h = (0, r.useMemo)(() => (0, v.parseIntervalValue)(m), [m]),
          D = (function (e, t) {
            return (0, r.useMemo)(() => {
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(l.InputControl, {
                  className: a()(b.inputWrapper, u.InputClasses.FontSizeLarge),
              ...
              D
                ? r.createElement('div', { className: b.hint }, M)
                : r.createElement(
                    'div',
                    { className: a()(b.hint, b.error) },
      ...
      function k(e) {
        if (
          M.dialogsOpenerManager.isOpened('ChangeIntervalDialog') ||
          M.dialogsOpenerManager.isOpened('SymbolSearch')
        )
          return;
          ...
          s = r.createElement(D, {
            ...
            onClose: function () {
              o.unmountComponentAtNode(t),
                M.dialogsOpenerManager.setAsClosed('ChangeIntervalDialog'),
                null == a || a();
            },
          });
        o.render(s, t),
          M.dialogsOpenerManager.setAsOpened('ChangeIntervalDialog');
      }
    },
    85508: (e) => {
      e.exports =
    ...
    35668: (e) => {
      e.exports = {
        ...
        pt: [
          'Digite o número do intervalo para gráficos de minutos (ou seja, 5 se for um gráfico de cinco minutos). Ou número mais letra para outros intervalos: S para 1 segundo (15S para 15 segundos, etc.), H (Para Hora), D (Diário), W (Semanal), M (Mensal) intervalos (ou seja, D ou 2H)',
        ],
