(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  ...
  {
    47461: (e) => {
      e.exports = { backButton: 'backButton-pbr_BOzj' };
    },
    21703: (e) => {
      e.exports = {
    ...
    80556: (e) => {
      e.exports = {
        ...
        withSidebar: 'withSidebar-E5yydi0j',
        content: 'content-E5yydi0j',
        tabContent: 'tabContent-E5yydi0j',
        applyToAllButton: 'applyToAllButton-E5yydi0j',
      };
    },
    1117: (e) => {
      e.exports = {
        themesButtonText: 'themesButtonText-hJtL5aqJ',
        themesButtonIcon: 'themesButtonIcon-hJtL5aqJ',
        defaultsButtonText: 'defaultsButtonText-hJtL5aqJ',
        defaultsButtonItem: 'defaultsButtonItem-hJtL5aqJ',
      };
    },
    45829: (e) => {
      e.exports = {
    ...
    22265: (e, t, a) => {
      ...
      function m(e) {
        const { mode: t, className: a, ...i } = e,
          ...
          m = n()(r.container, s && r.isTablet, o && r.isMobile, a);
      ...
      function h(e) {
        return l.createElement('div', { className: r.wrapper, ...e });
      }
      function d(e) {
        const { mode: t, title: a, icon: i, isActive: m, onClick: h, ...d } = e,
        ...
        return l.createElement(
          ...
          l.createElement(o.Icon, { className: r.icon, icon: i }),
          !u &&
            l.createElement(
              'span',
              { className: r.title },
              l.createElement('span', { className: r.titleText }, a),
              p && l.createElement(o.Icon, { className: r.nested, icon: s }),
            ),
        );
      }
    },
    72811: (e, t, a) => {
      'use strict';
      a.r(t), a.d(t, { GeneralChartPropertiesDialogRenderer: () => Z });
      var l = a(44352),
        i = a(50959),
        n = a(962),
        o = a(94720),
        ...
        C = a(8840),
        v = (a(93731), a(3615));
      const T = l.t(null, void 0, a(40837));
      var f = a(50655),
        k = a(86339),
        A = a(96040),
        S = a(51768),
      ...
      function B(e) {
        const {
          ...
          c = i.useCallback(() => {
            (0, C.loadTheme)(a, { themeName: t, standardTheme: !1 }).then(
              () => {
                a.readOnly() || window.saver.saveChartSilently(),
                  (0, S.trackEvent)('GUI', 'Switch to custom theme');
              },
            );
          }, [t, a]);
        return i.createElement(
          ...
          i.createElement(y.PopupMenuItem, {
            ...
            label: t,
            onClick: c,
            toolbox: i.createElement(A.RemoveButton, {
      ...
      var D = a(44996);
      const M = l.t(null, void 0, a(19611)),
        z = l.t(null, void 0, a(73169)),
        x =
          ((0, k.appendEllipsis)(l.t(null, void 0, a(9908))),
          l.t(null, void 0, a(75819)));
        ...
        constructor(e) {
          super(e),
            ...
            (this._handleApplyDefaults = () => {
              ...
              const a = (0, C.getCurrentTheme)().name;
              (0, C.loadTheme)(t, {
                themeName: a,
                standardTheme: !0,
                applyOverrides: !0,
          ...
          return i.createElement(
            ...
            n.length > 0 &&
              i.createElement(
                i.Fragment,
                null,
                i.createElement(_.PopupMenuSeparator, { key: 'separator' }),
                n.map((e) =>
                  i.createElement(B, {
                    key: e,
                    themeName: e,
      ...
      var R = a(48199),
        Y = a(47461);
      function j(e) {
        return i.createElement(R.BackButton, {
          className: Y.backButton,
          size: 'medium',
          'aria-label': l.t(null, { context: 'input' }, a(16936)),
          preservePaddings: !0,
          ...e,
        });
      }
      var H = a(80556);
      const U = 'properties_dialog.last_page_id';
      class J extends i.PureComponent {
        constructor(e) {
          ...
          super(e),
            ...
            (this._onChangeActivePageDefinitions = () => {
              L.logger.logNormal('Definition collection was updated'),
          ...
          const { pages: a, activePageId: l } = e,
            n = a.filter((e) => e.visible.value());
          let o =
            null !== (t = n.find((e) => e.id === l)) && void 0 !== t ? t : null;
          if (!o) {
            const e = d().getValue(U),
              t = n.find((t) => t.id === e);
            o = t || (n.length > 0 ? n[0] : null);
          }
          this.state = {
            activePage: o,
            visiblePages: n,
        ...
        render() {
          ...
          return i.createElement(
            ...
            (o) =>
              i.createElement(r.AdaptiveConfirmDialog, {
                className: H.withSidebar,
                dataName: 'series-properties-dialog',
                onClose: t,
                isOpened: e,
                title: null !== n && o ? n.title : l.t(null, void 0, a(74207)),
                footerLeftRenderer: this._renderFooterLeft,
                additionalButtons: this._renderApplyToAllButton(),
                additionalHeaderElement:
                  null !== n && o
                    ? i.createElement(j, { onClick: this._handleBackClick })
                    : void 0,
        ...
        _renderTabContent(e) {
          ...
          if (a) {
            ...
            return i.createElement(
              ...
              { className: H.tabContent, onScroll: this._handleScroll },
              i.createElement(
                ...
                i.createElement(
                  ...
                  l.map((e) =>
                    i.createElement(s.Section, { key: e.id, definition: e }),
                  ),
                ),
              ),
            );
          ...
          return i.createElement(
            ...
            (e) =>
              i.createElement(
                ...
                { rule: W.DialogBreakpoints.TabletSmall },
                (t) => {
                  const n = t ? 'mobile' : e ? 'tablet' : void 0;
                  return i.createElement(
                    V.DialogSidebarContainer,
                    { mode: n, onScroll: this._handleScroll },
                    a.map((e) =>
                      i.createElement(V.DialogSidebarItem, {
                        key: e.id,
                        mode: n,
                        'data-name': e.id,
                        title: e.title,
        ...
        _getCurrentPage(e) {
          const { pages: t } = this.props,
            { activePage: a } = this.state;
          let l = null;
          return a ? (l = a) : !e && t.length && (l = t[0]), l;
        }
      }
      var O = a(76422),
        F = a(88279);
      const K = l.t(null, void 0, a(74207));
      class Z extends F.DialogRenderer {
        constructor(e) {
          super(),
            (this._handleClose = () => {
