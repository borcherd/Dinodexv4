    ...
    63016: (t, e, i) => {
      ...
      class b extends s.PureComponent {
                ...
                s.createElement(
                  ...
                  s.createElement(
                    d,
                    {
                      ...
                      className: n(T.dialog, this.props.className),
                    },
                    !1,
                    this.props.children,
                  ),
        ...
        componentDidMount() {
          ...
          const { guard: n, calculateDialogPosition: a } = this.props;
          if (this.props.resizeHandler) this._resize = this.props.resizeHandler;
          else {
            const t = new y(s, { guard: n, calculateDialogPosition: a });
      ...
      (b.contextType = E.PortalContext),
        (b.defaultProps = {
          boundByScreen: !0,
          draggable: !0,
          centeredOnMount: !0,
        });
      const M = (0, c.makeOverlapable)(b);
    },
    76594: (t, e, i) => {
      'use strict';
      i.d(e, { OutsideEvent: () => n });
      var s = i(58095);
      function n(t) {
      ...
      function o(t) {
        return class extends s.PureComponent {
          render() {
            ...
            return 'parent' === i ? o : s.createElement(n.Portal, null, o);
          }
        };
      }
    },
