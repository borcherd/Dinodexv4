(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [1583],
  {
        ...
        hitTest(e) {
          ...
          R =
            e.y < 0
              ...
              : new r.Point(0.5 * c, (-c * Math.sqrt(3)) / 2);
          const w = e.subtract(R).length();
          return Math.abs(w - c) <= t
            ? new h.HitTestResult(h.HitTestResult.MOVEPOINT)
            : null;
        }
        _drawImpl(e) {
          ...
          let o = this._data.points[2];
          const l = (0, n.distanceToLine)(i, a, o).distance;
          if (l < 1)
            return (
              (t.strokeStyle = this._data.color),
              (t.lineWidth = this._data.linewidth),
      ...
      class _ extends l.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          (b = (0, s.transformPoint)(L, b)),
            ...
            (b = (0, s.transformPoint)(L, b)),
            (L = (0, s.scalingMatrix)(1, R / (2 * g))),
            (b = (0, s.transformPoint)(L, b));
          const P = b.y >= 0 ? new r.Point(_.x, _.y) : new r.Point(m.x, m.y);
          (P.data = 2), d.push(P);
          const S = [
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          t.translate(o, l),
            ...
            (t.fillStyle = this._data.color),
            t.fillText(this._data.label, n + a, r / 2);
        }
        _measureInfo(e, t, i) {
        ...
        _updateImpl() {
          ...
          if (_ > 0 && 2 === u.length) {
            const e = this._source.properties().childs(),
              ...
              [{ index: R }, { index: w }] = u,
              y = R < w ? this._points[0] : this._points[1],
              T = y.x,
      ...
      class p extends s.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          if (4 === i.points.length) {
            ...
            if (
              (0, o.quadroBezierHitTest)(s, n, u, e, t) ||
              (0, o.cubicBezierHitTest)(s, l, p, g, e, t) ||
        ...
        _drawImpl(e) {
          ...
          if (2 === this._data.points.length)
            ...
            const e = this._data.points[2],
              ...
              s = r.subtract(i),
              a = e.subtract(s.scaled(0.25)),
              o = e.add(s.scaled(0.25)),
              c = n.subtract(e),
            ...
            this._data.fillBack &&
              ...
              t.beginPath(),
              t.moveTo(i.x, i.y),
              t.quadraticCurveTo(a.x, a.y, e.x, e.y),
              t.bezierCurveTo(o.x, o.y, u.x, u.y, r.x, r.y),
              ...
              t.stroke(),
              this._data.leftEnd === d.LineEnd.Arrow &&
                (0, l.drawArrow)(a, i, t, t.lineWidth, 1),
              this._data.rightEnd === d.LineEnd.Arrow &&
      ...
      function c(e, t, i) {
        for (const r of i)
          for (let i = 1; i < r.length; i++) {
            const s = r[i - 1],
              o = r[i];
            if ((0, n.distanceToSegment)(s, o, e).distance < t)
              return new a.HitTestResult(a.HitTestResult.MOVEPOINT);
          }
        return null;
      }
      ...
      class p extends r.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          if (null !== this._data && 3 === this._data.points.length) {
            ...
            if (
              (0, o.quadroBezierHitTest)(r, i, l, e, t) ||
              (0, o.quadroBezierHitTest)(r, n, h, e, t)
            )
              return new a.HitTestResult(a.HitTestResult.MOVEPOINT);
        ...
        _drawImpl(e) {
          ...
          if (
            ...
            const e = i.subtract(t),
              a = n.subtract(e.scaled(0.25)),
              o = n.add(e.scaled(0.25));
            this._data.fillBack &&
              this._data.points.length > 2 &&
              ((r.fillStyle = this._data.backColor),
              r.beginPath(),
              r.moveTo(t.x, t.y),
              r.quadraticCurveTo(a.x, a.y, n.x, n.y),
              r.quadraticCurveTo(o.x, o.y, i.x, i.y),
              r.fill()),
              r.beginPath(),
              ...
              this._data.leftEnd === s.LineEnd.Arrow &&
                (0, l.drawArrow)(a, t, r, r.lineWidth, 1),
              this._data.rightEnd === s.LineEnd.Arrow &&
                (0, l.drawArrow)(o, i, r, r.lineWidth, 1);
          }
        }
      }
    },
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          if (t.subtract(e).length() < 3)
            return new u.HitTestResult(u.HitTestResult.CHANGEPOINT);
        ...
        _drawImpl(e) {
          ...
          (this._textSizeCache.totalWidth = a),
            (this._textSizeCache.totalHeight = o);
          let c = i.x - a / 2,
            u = i.y - o / 2,
            p = 0;
          const _ = s + 4 > 16,
            ...
            21 === p
              ? g
                ? (n.lineTo(a, i.y - 8),
                  ...
                  n.lineTo(a, i.y + 8),
                  n.lineTo(a, o - 8))
                : (n.lineTo(t.x, t.y), n.lineTo(a, o - 8))
              : n.lineTo(a, o - 8),
            22 === p
              ? (n.lineTo(t.x, t.y), n.lineTo(a - 8, o))
              : n.arcTo(a, o, a - 8, o, 8),
            12 === p
              ? _
                ? (n.lineTo(i.x + 8, o),
                  ...
                  n.lineTo(i.x - 8, o),
                  n.lineTo(8, o))
                : (n.lineTo(t.x, t.y), n.lineTo(8, o))
              : n.lineTo(8, o),
            2 === p
              ? (n.lineTo(t.x, t.y), n.lineTo(0, o - 8))
              : n.arcTo(0, o, 0, o - 8, 8),
            1 === p
              ? g
                ? (n.lineTo(0, i.y + 8),
    ...
    95007: (e, t, i) => {
      'use strict';
      var n = i(86441).Point,
        r = i(4754).LineSourcePaneView,
        s = i(6612).VerticalLineRenderer,
        a = i(9933).TrendLineRenderer,
        o = i(14888).HitTestResult,
        l = i(29639).CompositeRenderer,
        d = i(85113).LineEnd;
    ...
    17269: (e, t, i) => {
      ...
      class g extends u.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          t.translate(l, d),
            (0, _.drawRoundRect)(t, 0, 0, s, r, [o, o, o, 2]),
            (t.fillStyle = this._data.backgroundColor),
            t.fill(),
            (t.strokeStyle = this._data.borderColor),
            (t.lineWidth = 2),
        ...
        _updateImpl(e, t) {
          ...
          if ((this._commentRenderer.setData(a), 1 === a.points.length)) {
            ...
            return (
              ...
              e.append(this.createLineAnchor({ points: a.points }, 0)),
              void (this._renderer = e)
            );
          }
    ...
    64484: (e, t, i) => {
      'use strict';
      i.d(t, { DateAndPriceRangeBasePaneView: () => o });
      var n = i(86441),
        r = i(17364),
        s = i(44381),
        a = i(4754);
      class o extends a.LineSourcePaneView {
        ...
        _updateCustomTextRenderer(e, t) {
          ...
          if (i.visible.value() && i.text.value().length > 0) {
            const [a, o] = this._points,
              l = Math.round((a.y + o.y) / 2),
              d = new n.Point(a.x, l),
              h = new n.Point(o.x, l),
              c = d.x < h.x ? d : h,
              u = c === d ? h : d,
    ...
    69426: (e, t, i) => {
      ...
      const m = new _.TimeSpanFormatter(),
        R = new c.PercentageFormatter(),
        w = new f.VolumeFormatter(),
      ...
      class b extends x.DateAndPriceRangeBasePaneView {
        ...
        _updateImpl(e, t) {
          ...
          const h = s.drawBorder.value() ? s.borderWidth.value() / 2 : 0,
            ...
            f = new r.Point(l.x + Math.sign(d.x - l.x) * h, _),
            x = new r.Point(d.x + Math.sign(l.x - d.x) * h, _);
          this._distanceLineRenderer.setData({
            ...
            rightend:
              Math.abs(l.x - d.x) >= 25 * s.linewidth.value()
                ? p.LineEnd.Arrow
                : p.LineEnd.Normal,
          ...
          const b = Math.round((l.x + d.x) / 2),
            L = new r.Point(b, l.y + Math.sign(d.y - l.y) * h),
            P = new r.Point(b, d.y + Math.sign(l.y - d.y) * h);
          this._distancePriceRenderer.setData({
            ...
            leftend: p.LineEnd.Normal,
            rightend:
              Math.abs(L.y - P.y) >= 25 * s.linewidth.value()
                ? p.LineEnd.Arrow
                : p.LineEnd.Normal,
            excludeBoundaries: null != c ? c : void 0,
          }),
          ...
          const S = this._source.points()[0].price,
            ...
            A = this._source.points()[1].index,
            k = A - N,
            D = (0, a.forceLTRStr)(k + ''),
            E = this._model.timeScale().indexToUserTime(N),
            B = this._model.timeScale().indexToUserTime(A);
          let z = '';
          if (E && B) {
            const e = (B.valueOf() - E.valueOf()) / 1e3;
            z = ', ' + (0, a.startWithLTR)(m.format(e));
          }
          ...
          const H =
            (0, n.ensureNotNull)(this._source.ownerSource())
              ...
              .format(M) +
            ' (' +
            R.format(Math.round(100 * I) / 100) +
            ') ' +
            (this._pipFormatter ? this._pipFormatter.format(M) : '');
          let V = (0, a.forceLTRStr)(H) + '\n' + y.format({ count: D }) + z;
          const W = this._source.volume();
          let F;
          Number.isNaN(W) || (V += `\n${T} ${w.format(W)}`),
            (F =
              C > S
                ? new r.Point(0.5 * (l.x + d.x), d.y - 2 * s.fontsize.value())
                : new r.Point(
                    0.5 * (l.x + d.x),
          ...
          const Y = { x: 0, y: 10 },
            ...
            U = {
              ...
              fontsize: j,
              backgroundRoundRect: 4,
              backgroundHorzInflate: 0.4 * j,
              backgroundVertInflate: 0.2 * j,
            };
      ...
      class m extends g.DateAndPriceRangeBasePaneView {
        constructor() {
          super(...arguments),
            ...
            (this._backgroundRenderer = new o.RectangleRenderer()),
        ...
        _updateImpl(e, t) {
          ...
          R(this._leftBorderRenderer, new n.Point(d.x, g), new n.Point(d.x, m)),
            R(
              this._rightBorderRenderer,
              new n.Point(p.x, g),
              new n.Point(p.x, m),
            );
          const w = Math.round((d.y + p.y) / 2),
            y = new n.Point(d.x, w),
            T = new n.Point(p.x, w),
          ...
          this._distancePriceRenderer.setData({
            ...
            this._renderer.append(this._distancePriceRenderer);
          const L = this._source.points()[0].index,
            P = this._source.points()[1].index,
            S = P - L,
            C = this._model.timeScale().indexToUserTime(L),
            M = this._model.timeScale().indexToUserTime(P);
          let I = '';
          if (C && M) {
          ...
          const N = this._source.volume(),
            A = Number.isNaN(N) ? '' : `\n${x} ${f.format(N)}`,
            k = v.format({ count: (0, s.forceLTRStr)(S.toString()) }) + I + A,
            D = { x: 0, y: 10 },
            E = r.fontsize.value(),
            B = {
              text: k,
              ...
              fontsize: E,
              backgroundRoundRect: 4,
              backgroundHorzInflate: 0.4 * E,
              backgroundVertInflate: 0.2 * E,
            };
          (null === (i = r.fillLabelBackground) || void 0 === i
            ...
            (B.backgroundColor = r.labelBackgroundColor.value())),
            this._textRenderer.setData(B);
    ...
    71841: (e, t, i) => {
      'use strict';
      var n = i(4112).DisjointChannelRenderer,
        r = i(9933).TrendLineRenderer,
        s = i(44381).TextRenderer,
        a = i(29639).CompositeRenderer,
        o = i(6947).PaneCursorType,
        l = i(17364),
        d = i(20575).AlertableLineSourcePaneView,
          ...
          if (
            ...
            if (!(this._points.length < 2)) {
              ...
              this._model.lineBeingCreated() === this._source && w.pop(),
                o.append(
                  this.createLineAnchor({ points: w, pointsCursorType: h }, 0),
                ),
    ...
    72284: (e, t, i) => {
      ...
      class f extends _.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          (v = (0, c.rotationMatrix)(-f)),
            ...
            (x = (0, c.transformPoint)(v, x));
          const m = e.length(),
            R = (0, g.interactionTolerance)().curve;
          return Math.abs(m - 0.5 * h) <= R
            ? new p.HitTestResult(p.HitTestResult.MOVEPOINT)
            : this._data.fillBackground &&
              !this._data.noHitTestOnBackground &&
              m <= 0.5 * h
            ? new p.HitTestResult(p.HitTestResult.MOVEPOINT_BACKGROUND)
            : null;
        }
        _drawImpl(e) {
          if (null === this._data || this._data.points.length < 2) return;
      ...
      class v extends h.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          m.data = 2;
          const R = new r.Point(f.x, f.y);
          (R.data = 3),
            t.showLabel.value() &&
              (null === (e = t.text) || void 0 === e ? void 0 : e.value()) &&
              this._updateTextRenderer(v, x, m, R) &&
              s.append(this._textRenderer);
          const w = (0, h.thirdPointCursorType)(v, x),
            y = [l.PaneCursorType.Default, l.PaneCursorType.Default, w, w];
          s.append(
            this.createLineAnchor(
              { points: [v, x, m, R], pointsCursorType: y },
              0,
            ),
          ),
            (this._renderer = s);
    ...
    57108: (e, t, i) => {
      ...
      class o extends a.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          if (
            ('buy' === this._data.direction
              ? ((a = n), (o = n + r))
              : ((a = n - r), (o = n)),
            e.x >= i - 2 && e.x <= i + 2 && e.y >= a && e.y <= o)
          ) {
            const e = this._data.tooltip;
            return new s.HitTestResult(s.HitTestResult.CUSTOM, {
              tooltip:
                '' !== e
                  ? { text: e, rect: { x: i, y: a, w: 2, h: o - a } }
                  : void 0,
            });
          }
          return null;
        ...
        _drawImpl(e) {
          ...
          if (0 !== c) {
            ...
            })(t, Math.round(i + 0.5 - c / 2), e, c, a, l, d, h);
          }
        }
      }
      var l = i(88620);
      class d extends r.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (!d) return;
          const h = d.getXYCoordinate(a, o, s[0].index);
          !isFinite(h.y) ||
            h.y < 0 ||
            h.y > e ||
            h.x < 0 ||
            (this._executionRenderer.setData({
              ...
              arrowColor: a.getArrowColor(),
              arrowHeight: a.getArrowHeight(),
              direction: a.getDirection(),
              tooltip: a.getTooltip(),
              arrowSpacing: a.getArrowSpacing(),
              fontHeight: l.fontHeight(a.getFont()),
              text: a.getText(),
              textColor: a.getTextColor(),
              font: a.getFont(),
            }),
      ...
      class u extends d.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl(e, t) {
          ...
          for (let i = 1; i < f; i++) {
            ...
            if (!a) break;
            const o = v.scaled(s.coeff.value()),
              x = _.add(o),
              m = g.add(o),
              R = v.scaled(a.coeff.value()),
              w = _.add(R),
              y = g.add(R),
          ...
          if (null !== x) {
            ...
            if (i.visible.value()) {
              ...
              null !== f &&
                (u.append(f),
                (m =
                  null !== (o = (0, h.getTextBoundaries)(f, t, e)) &&
                  void 0 !== o
                    ? o
                    : void 0));
              const R = {
              ...
              this._lastLevelTrendRenderer.setData(R),
    ...
    19651: (e, t, i) => {
      'use strict';
      var n = i(86441).Point;
      const { LineToolPaneViewFibWithLabels: r } = i(45306);
      var s = i(9933).TrendLineRenderer,
        a = i(14888).HitTestResult,
        o = i(29639).CompositeRenderer,
        l = i(99829).EllipseRendererSimple,
        d = i(85113).LineEnd;
          ...
          if (
            ...
            for (
              ...
              if (u.visible.value()) {
                ...
                var f = new n(this._center.x, this._center.y + 0.5 * r * p);
                this._levels.push({
                  color: _,
                  points: g,
                  labelPoint: f,
            ...
            if (!(this._points.length < 2)) {
              var v = new o(),
                ...
                m = s.transparency.value();
              for (c = 0; c < this._levels.length; c++) {
                var R = this._levels[c],
                  w = {};
                (w.points = R.points),
                  (w.color = R.color),
                  (w.linewidth = R.linewidth),
                  (w.backcolor = R.color),
                  c > 0 && (w.wholePoints = this._levels[c - 1].points),
                  (w.fillBackground = x),
                  (w.transparency = m);
                var y = new a(a.MOVEPOINT, null, R.index);
                v.append(new l(w, y));
      ...
      class u extends c.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl(e, t) {
          ...
          const S = f ? p.price : _.price,
            ...
            N = { price: S, coordinate: I },
            A = { price: M, coordinate: c.priceToCoordinate(C, u) - I },
            k = this._source.levelsCount();
          for (let e = 1; e <= k; e++) {
            const t = g['level' + e].childs();
            if (!t || !t.visible.value()) continue;
            const i = t.coeff.value(),
              n = (0, h.fibLevelCoordinate)(N, A, i, c, u, L),
              r = (0, h.fibLevelPrice)(N, A, i, c, u, L);
            this._levels.push({
              color: t.color.value(),
              y: n,
              price: r,
          ...
          for (let i = 0; i < this._levels.length; i++) {
            const r = new n.Point(D, this._levels[i].y),
              h = new n.Point(E, this._levels[i].y),
            ...
            if (
              ...
              null !== c &&
                ...
                (n =
                  null !== (l = (0, a.getTextBoundaries)(c, t, e)) &&
                  void 0 !== l
                    ? l
                    : void 0);
              const u = {
    ...
    83305: (e, t, i) => {
      ...
      class _ extends u.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          const w = new l.CompositeRenderer(),
            y = this._points[0],
            T = this._points[1],
            b = Math.min(y.x, T.x),
            L = Math.min(y.y, T.y),
      ...
      class u extends h.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e) {
          ...
          const t = this._data.points[0],
            ...
            s = r.transposed(),
            a = n.normalized();
          let l = Math.acos(r.dotProduct(a));
        ...
        _updateImpl(e, t) {
          ...
          for (let a = 0; a < this._levels.length; a++) {
            ...
            if (p.showLabels.value()) {
              ...
              switch (v) {
                case 'top':
                  r = new n.Point(this._levels[a].x, 0);
                  break;
                case 'middle':
                  r = new n.Point(this._levels[a].x, 0.5 * e);
                  break;
                default:
                  r = new n.Point(this._levels[a].x, e);
              }
              const l = {
                  points: [r],
    ...
    39484: (e, t, i) => {
      'use strict';
      const { LineToolPaneViewFibWithLabels: n } = i(45306);
      var r = i(86441).Point,
        s = i(9933).TrendLineRenderer,
        a = i(14888).HitTestResult,
        o = i(29639).CompositeRenderer,
        l = i(56456).ArcWedgeRenderer,
        d = i(85113).LineEnd;
        ...
        _updateRenderer() {
          if (!((v = this._points).length < 2)) {
            ...
            for (var p = this._levels.length - 1; p >= 0; p--) {
              ...
              var f = new l();
              f.setData(g),
                f.setHitTest(new a(a.MOVEPOINT, null, _.index)),
                e.append(f);
    ...
    98404: (e, t, i) => {
      ...
      var n = i(4112).DisjointChannelRenderer,
        ...
        a = i(29639).CompositeRenderer,
        o = i(17364),
        l = i(20575).AlertableLineSourcePaneView;
    ...
    94122: (e, t, i) => {
      ...
      class o extends a.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          this._data.fillBack &&
            (this._data.point.x < this._data.center.x && ((o = -o), (d = -d)),
            t.beginPath(),
            t.moveTo(d, 0),
            t.lineTo(o, 0),
            t.arcTo(o, o, 0, o, Math.abs(o)),
            t.lineTo(0, d),
            ...
            this._data.point.x > this._data.center.x
              ? t.arc(0, 0, Math.abs(o), 0, Math.PI / 2, !1)
              : t.arc(0, 0, Math.abs(o), -Math.PI / 2, -Math.PI, !0),
            t.scale(1, 1 / s),
            t.stroke();
        }
      }
    ...
    82528: (e, t, i) => {
      ...
      class u extends r.LineSourcePaneView {
        ...
        _prepareLabels(e, t) {
          ...
          if (null === x) return;
          const m = o.getScaleRatioFormatter(),
            R = (0, c.forceLTRStr)(m.format(x)),
            w = this._getLabelData(r, R);
          (w.horzAlign = h > 0 ? 'left' : 'right'),
            (w.vertAlign = d > 0 ? 'bottom' : 'top'),
            (w.offsetX = 10),
            (w.offsetY = d > 0 ? 8 : 10),
            (w.forceTextAlign = !0),
            this._ratioTextRenderer.setData(w),
    ...
    1498: (e, t, i) => {
      ...
      var n = i(86441).Point,
        r = i(4754).LineSourcePaneView,
        s = i(44381).TextRenderer,
        a = i(26740).RectangleRenderer,
        o = i(9933).TrendLineRenderer,
        l = i(29639).CompositeRenderer,
        d = i(34657).NumericFormatter,
        h = i(85113).LineEnd,
        c = i(17364);
          ...
          if (
            ...
            for (p = 1; p <= 7; p++) {
              ...
              if ((R = C['vlevel' + p]).visible.value()) {
                (_ = R.coeff.value()), (g = R.color.value());
                var w = Math.round(m + _ * x),
                  y = this._model.timeScale().indexToCoordinate(w);
            ...
            if (
              ...
              for (p = 1; p <= 7; p++) {
                (w = Math.round(m + C['hlevel' + p].coeff.value() * x)),
                  (f = d + C['vlevel' + p].coeff.value() * r);
                this._hfans.push(this._model.timeScale().indexToCoordinate(w)),
                  this._vfans.push(
            ...
            for (p = 0; p < this._hlevels.length; p++) {
              if (p > 0 && M) {
                ...
                (e = new n(b, this._hlevels[p].y)), (t = new n(P, k.y));
                ((z = {}).points = [e, t]),
                  (z.color = this._hlevels[p].color),
                  (z.linewidth = 0),
                  (z.backcolor = this._hlevels[p].color),
                  (z.fillBackground = !0),
                  (z.transparency = I),
                  (z.extendLeft = !1),
                  (z.extendRight = !1),
                  (H = new a(void 0, void 0, !0)).setData(z),
                  T.append(H);
              }
              var D = {
                points: [
                  (e = new n(b, this._hlevels[p].y)),
                  (t = new n(P, this._hlevels[p].y)),
                ],
                width: this._model.timeScale().width(),
                height: this._source.priceScale().height(),
            ...
            for (p = 0; p < this._vlevels.length; p++) {
              ...
              if (p > 0 && N) {
                ...
                var z,
                  O = new n(k.x, L);
                ((z = {}).points = [O, t]),
                  (z.color = this._vlevels[p].color),
                  (z.linewidth = 0),
                  (z.backcolor = this._vlevels[p].color),
                  (z.fillBackground = !0),
                  (z.transparency = A),
                  (z.extendLeft = !1),
                  (z.extendRight = !1),
              ...
              if (
                ((H = new o()).setData(D), T.append(H), C.showTopLabels.value())
              ) {
                var V = {
                  points: [e],
      ...
      class _ extends u.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          const v = g.drawWick.value(),
            ...
            R = g.wickColor.value(),
            w = new o.CompositeRenderer();
          w.setGlobalAlpha(1 - _.transparency.value() / 100);
          ...
          for (let e = 0; e < this._segments.length; e++) {
            ...
            w.append(new c.PaneRendererCandles(t));
          }
          f.append(w), this.addAnchors(f), (this._renderer = f);
        }
      }
    },
    19972: (e, t, i) => {
      ...
      class g extends u.LineSourcePaneView {
        ...
        _updateImpl() {
          let e, t;
          super._updateImpl(), (this._renderer = null);
          const [i, r, a, o, l, c, u] = this._points;
          if (this._points.length >= 5) {
            const s = (0, n.intersectLineSegments)(a, l, i, r);
            if (null !== s) {
              const t = l.subtract(a);
              e = a.add(t.scaled(s));
            }
            if (7 === this._points.length) {
              const e = (0, n.intersectLineSegments)(a, l, c, u);
              if (null !== e) {
        ...
        _updateImpl(e, t) {
          ...
          if (
            ...
            this._labelRenderer.setData(_),
              o.append(this._labelRenderer),
              this._needLabelExclusionPath(this._labelRenderer) &&
                (h =
                  null !==
                    (i = (0, a.getTextBoundaries)(this._labelRenderer, t, e)) &&
                  void 0 !== i
                    ? i
                    : void 0),
    ...
    64019: (e, t, i) => {
      ...
      class u {
        ...
        draw(e, t) {
          ...
          const o = this._data.excludeBoundaries;
          void 0 !== o && (e.save(), (0, c.addExclusionArea)(e, t, o)),
        ...
        hitTest(e) {
          ...
          return Math.abs(e.y - this._data.points[0].y) <= t
            ? new o.HitTestResult(this._data.hitTestResult, {
                snappingPrice: this._data.snappingPrice,
              })
            : null;
        }
      }
      class p extends l.AlertableLineSourcePaneView {
        constructor(e, t) {
          super(e, t),
    ...
    4754: (e, t, i) => {
      'use strict';
      i.d(t, { thirdPointCursorType: () => u, LineSourcePaneView: () => p });
      var n = i(7394),
        r = i(50151),
        s = i(78996),
        a = i(14888),
    ...
    45306: (e, t, i) => {
      ...
      class d extends r.LineSourcePaneView {
        ...
        _updateLabelForLevel({
          ...
          switch (P) {
            case 'left':
              (L = i.y), h ? (b = T ? 0 : r.x) : ((b = i.x), (P = 'right'));
              break;
            case 'right':
              (L = r.y),
                c
          ...
          return (
            w && (C += '(' + x.formatPrice(s, y) + ')'),
            v.setData({
              points: [new n.Point(b, L)],
              text: C,
              color: a,
              vertAlign: d,
              horzAlign: P,
    ...
    63261: (e, t, i) => {
      ...
      class v {
        ...
        _createSource(e, t, i) {
          ...
          (0, u.drawScaled)(r, this._renderParams.pixelRatio, () => {
            const n = 0.6 * e;
            (r.fillStyle = i),
              r.beginPath(),
              r.moveTo(e / 2, t),
      ...
      class x {
        ...
        _drawTooltipOn(e, t) {
          ...
          const v = o.x < 20 || o.x + 20 > i.vpWidth;
          let x = v ? null : 'top',
            m = v ? 0 : Math.round(o.x);
          f < 10 ? (f = o.y + 13) : (x = 'bottom'),
            g < 10
              ? (g += Math.abs(g - 10))
            ...
            (e.lineWidth = 1),
            e.beginPath();
          const R = Math.round(g * t.pixelRatio),
            w = Math.round(f * t.pixelRatio);
          ...
          e.moveTo(R, w),
            v ||
              'top' !== x ||
              (e.lineTo(m - y, w), e.lineTo(m, w - y), e.lineTo(m + y, w)),
            e.lineTo(R + p, w),
            e.lineTo(R + p, w + _),
            v ||
              'bottom' !== x ||
          ...
          (0, u.drawScaled)(e, t.pixelRatio, () => {
            for (let t = 0; t < a.length; t++)
              e.fillText(a[t].replace(/^\s+/, ''), b, L), (L += i.fontSize + l);
          }),
            e.restore();
        }
      }
    ...
    73741: (e, t, i) => {
      ...
      var n = i(86441),
        ...
        c = i(86339),
        u = i(88620);
      const p = a.t(null, void 0, i(33241)),
        _ = a.t(null, void 0, i(16075));
      class g extends d.MediaCoordinatesPaneRenderer {
        ...
        _drawImpl(e) {
          ...
          0 !== n &&
            ...
            (u = !0)),
            0 !== r &&
              (this._drawQuantity(t, d + n, c, u),
              this._drawQuantityText(t, d + n, c),
              (u = !0)),
            0 !== this._cancelButtonWidth() &&
              this._drawCancelButton(t, d + n + r, c, u);
        }
        _height() {
          return Math.max(
            20,
    ...
    72948: (e, t, i) => {
      'use strict';
      var n = i(4754).LineSourcePaneView,
        r = i(88620),
        s = i(14888).HitTestResult,
        a = i(66291).splitThousands,
        o = i(80142),
        l = i(86339).appendEllipsis,
        d = i(86216).MediaCoordinatesPaneRenderer;
      const { setLineStyle: h, drawLine: c, drawPoly: u } = i(9740),
        { LINESTYLE_SOLID: p } = i(53479);
      class _ extends d {
        constructor(e, t) {
        ...
        _drawLines(e, t, i, n, r) {
          e.save(),
            ...
            (e.lineWidth = this._adapter.getLineWidth()),
            c(e, i, n, r, n),
            this._adapter.getExtendLeft() && c(e, 0, n, t, n),
            e.restore();
        }
        _drawBody(e, t, i) {
          (e.strokeStyle = this._adapter.getBodyBorderColor()),
        ...
        _drawQuantityText(e, t, i) {
          ...
          var n = t + this._quantityWidth(e) / 2,
            r = i + this._height() / 2;
          e.fillText(o.startWithLTR(this._getQuantity() + ''), n, r),
            e.restore();
        }
        ...
        _drawImpl(e) {
          if (
            ...
            var t = e.context,
              ...
              a = n + r + s + this._closeButtonWidth(),
              o = i - a,
            ...
            (this._cache.bodyRight = h + n),
              ...
              0 !== s &&
                this._drawReverseButton(t, this._cache.quantityRight, u),
            ...
            ? new s(s.CUSTOM, {
                ...
                tooltip: {
                  text:
                    ...
                    l(i(44352).t(null, void 0, i(11810))),
                  rect: {
      ...
      t.PositionPaneView = class extends n {
        constructor(e, t) {
          super(e, t),
            (this._rendererCache = {}),
            (this._renderer = new _(this._rendererCache, e._adapter));
        }
        renderer(e, t) {
          return (
            this._invalidated && this._updateImpl(),
    ...
    58497: (e, t, i) => {
      ...
      var n = i(86441).Point,
        ...
        l = i(28866).getImage,
        d = i(91031),
        h = i(18766).PercentageFormatter,
        c = i(86985).DateFormatter,
        u = i(78831).TimeFormatter,
        p = i(78831).hourMinuteFormat,
        _ = i(78831).hourMinuteSecondFormat,
        g = i(45063).TimeSpanFormatter,
        f = i(38031),
        v = i(69960),
        x = i(83499).calcTextHorizontalShift,
        m = i(80142).isRtl,
        R = i(9740).drawRoundRect,
        w = i(95242).makeFont,
        y = i(86216).MediaCoordinatesPaneRenderer,
        T = i(80142),
        b = T.forceLTRStr,
        L = T.startWithLTR,
        P = i(17364).CHART_FONT_FAMILY;
      class S extends y {
        constructor() {
          super(),
            (this._data = null),
        ...
        drawTargetLabel(e) {
          ...
          var t = w(this._targetFontSize1, this._font, 'normal'),
            n = w(this._targetFontSize2, this._font, 'normal'),
          ...
          (e.font = t), (e.textAlign = m() ? 'right' : 'left');
          var C = x(e, S - d - h);
          e.fillText(r, L + C, P);
          var M = x(e, S - l);
          e.fillText(s, L + l + h + M, P), (e.font = n);
          var I = P + this._targetFontSize1 + 3,
            N = x(e, S - u - _ - p);
          e.fillText(a, L + N, I);
          var A = x(e, S - c - p - _ - u);
          this._data.clockWhite &&
            e.drawImage(this._data.clockWhite, L + c + p + A, I + 1);
          var k = x(e, S - c - _);
          if ((e.fillText(o, L + c + _ + 2 * p + k, I), this._data.status)) {
            var D, E, B, z;
            switch (
              ((e.font = w(this._targetFontSize1, this._font, 'bold')),
              this._data.status)
            ) {
              case v.AlertStatus.Success:
            ...
            (e.fillStyle = E),
              'up' === this._data.direction
                ? (R(e, b.x - 1, b.y - O - 2, this._targetWidth + 2, O, 5),
                  e.fill(),
                  (e.fillStyle = B),
                  e.fillText(D, b.x + V + W, b.y - O + 1),
                  z &&
                    e.drawImage(
                      z,
                      b.x + V - z.width - 4,
                      b.y - O - 2 + Math.abs(O - z.height) / 2,
                    ))
                : (R(
                    e,
                    b.x - 1,
        ...
        drawStartLabel(e) {
          ...
          (e.fillStyle = f.generateColor(
            ...
            e.stroke(),
            (e.textAlign = m() ? 'right' : 'left'),
            (e.textBaseline = 'top'),
            (e.fillStyle = this._data.sourceTextColor);
          var l = x(e, this._sourceWidth - 6 - 4),
            d = 2 + o.x + 3 + l,
            h = 2 + o.y + 2;
          (e.font = t),
        ...
        _drawImpl(e) {
          if (!(null === this._data || this._data.points.length < 2)) {
            ...
            if (Math.abs(r.x) < 1 || Math.abs(r.y) < 1)
              ...
              (o = Math.atan((h - l) / (c - d))), r.x * r.y < 0 && (o = -o);
            }
            t.save(),
              t.beginPath(),
              t.translate(n.x, n.y),
        ...
        sourceLabelHitTest(e) {
          ...
          var t = 'up' === this._data.direction ? 1 : -1,
            ...
            s = n.y + i * t,
            o = n.y + (i + this._sourceHeight + this._arrowHeight) * t,
            l = Math.min(s, o),
            d = Math.max(s, o);
          return e.x >= r &&
        ...
        hitTest(e) {
          ...
          var t = this._data.points[0],
            ...
            s = Math.abs(n.x),
            o = Math.abs(n.y),
            l = d.sign(n.y) * (o - o * Math.sqrt(1 - (r.x * r.x) / (s * s)));
          if (Math.abs(l - r.y) < 3) return new a(a.MOVEPOINT);
      ...
      t.PredictionPaneView = class extends r {
        constructor(e, t) {
          ...
          (this._clockWhite = null),
            ...
            l('prediction-clock-white', i(99620)).then(function (e) {
              (n._clockWhite = e), r();
            }),
            l('prediction-success-white', i(14012)).then(function (e) {
              (n._successIcon = e), r();
            }),
            l('prediction-failure-white', i(88249)).then(function (e) {
              (n._failureIcon = e), r();
            }),
        ...
        _updateImpl() {
          if (
            ...
            var r = t.price - n.price,
              a = (r / Math.abs(n.price)) * 100;
            this._targetLine1 = b(
              e.format(r) + ' (' + this._percentageFormatter.format(a) + ')',
            );
            var l = this._model.timeScale().indexToUserTime(n.index),
              d = this._model.timeScale().indexToUserTime(t.index);
            n.time &&
              t.time &&
              ((l = TradingView.isString(n.time)
            ...
            var h = this._model.mainSeries().isDWM(),
              ...
              x = f.isSeconds() || f.isTicks();
            if (d && l) {
              (this._targetLine4 = new c().format(d)),
                h ||
                  (this._targetLine4 =
                    this._targetLine4 + '  ' + new u(x ? _ : p).format(d));
              var m = (d.valueOf() - l.valueOf()) / 1e3;
              this._targetLine2 =
            ...
            var R = this._model.timeScale().indexToUserTime(n.index);
            R &&
              ((this._sourceLine2 = new c().format(R)),
              h ||
                (this._sourceLine2 =
                  this._sourceLine2 + ' ' + new u(x ? _ : p).format(R))),
              (this._direction =
                this._source.direction() === v.Direction.Up ? 'up' : 'down'),
              (this._finished =
                this._model.lineBeingCreated() !== this._source &&
    ...
    65409: (e, t, i) => {
      ...
      var n = i(86441),
        ...
        o = i(4754).LineSourcePaneView,
        l = i(53074).SelectionRenderer,
        d = i(14888).HitTestResult,
        h = i(29639).CompositeRenderer,
        c = i(38031),
        u = i(83499).calcTextHorizontalShift,
        p = i(80142).isRtl,
        _ = i(86216).MediaCoordinatesPaneRenderer,
        g = i(17364);
      class f extends _ {
        constructor(e, t) {
          super(),
      ...
      class v extends g.DateAndPriceRangeBasePaneView {
        ...
        _updateImpl(e, t) {
          ...
          o.fillBackground.value() &&
            (this._backgroundRenderer.setData({
              points: [new r.Point(v, h.y), new r.Point(x, g.y)],
              color: 'white',
              linewidth: 0,
          ...
          const y = Math.round((h.x + g.x) / 2),
            T = new r.Point(y, h.y),
            b = new r.Point(y, g.y),
            L = this._updateCustomTextRenderer(e, t);
          this._distanceRenderer.setData({
            ...
            leftend: u.LineEnd.Normal,
            rightend:
              Math.abs(T.y - b.y) >= 15 * o.linewidth.value()
                ? u.LineEnd.Arrow
                : u.LineEnd.Normal,
            excludeBoundaries: null != L ? L : void 0,
          }),
          ...
          A =
            S > P
              ? new r.Point(0.5 * (h.x + g.x), g.y - 2 * o.fontsize.value())
              : new r.Point(0.5 * (h.x + g.x), g.y + 0.7 * o.fontsize.value());
          const k = { x: 0, y: 10 },
            D = o.fontsize.value(),
            E = {
              points: [A],
          ...
          (null === (i = o.fillLabelBackground) || void 0 === i
            ? void 0
            : i.value()) &&
            ((E.boxShadow = {
            ...
            (E.backgroundColor = o.labelBackgroundColor.value())),
            this._labelRenderer.setData(E);
          const B = this._labelRenderer.measure(),
            z = (0, a.calculateLabelPosition)(B, h, g, k, e);
          this._labelRenderer.setPoints([z]),
    ...
    4898: (e, t, i) => {
      'use strict';
      var n = i(56456).ArcWedgeRenderer,
        r = i(39484).FibWedgePaneView,
        s = i(9933).TrendLineRenderer,
        a = i(29639).CompositeRenderer,
        o = i(85113).LineEnd;
    ...
    69138: (e, t, i) => {
      ...
      class h extends l.LineSourcePaneView {
        ...
        _addAnchors(e, t, i) {
          ...
          i.append(
            this.createLineAnchor(
              { points: [e, t, r, s, a, o, l, h], pointsCursorType: _ },
              0,
            ),
          );
        }
            ...
            (this._data = (function (e, t) {
              ...
              for (let r = 0; r < d.length; r++) {
                ...
                const l = s.priceToCoordinate(a, v),
                  p = s.priceToCoordinate(o, v),
                  x = new c.Point(h, l),
                  m = new c.Point(_, p),
                  R = f[r].color.value(),
                  w = f[r].linewidth.value(),
    ...
    69973: (e, t, i) => {
      ...
      const T = [
        ...
        L = s.t(null, { context: 'line_tool_position' }, i(50140)),
        P = s.t(null, { context: 'line_tool_position' }, i(44143)),
      ...
      class N extends a.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (null === f) return;
          const x = this._points[v.RiskRewardPointIndex.Entry].y,
            m = s.priceToCoordinate(c, f),
            R = s.priceToCoordinate(u, f),
            w = s.priceToCoordinate(h.closePrice, f),
            y = i.indexToCoordinate(h.index),
            b = this._points[v.RiskRewardPointIndex.Entry].x,
            ...
            P = this._points[v.RiskRewardPointIndex.ActualClose]
          ...
          let A = S < -5 || b > t + 5;
          if (
            (this._createBackgroundRenderers(N, this._renderer),
            this._createLinesRenderers(N, this._renderer),
            this._createLabelsRenderers(N, this._renderer, g),
            ...
            ].reduce((i, n) => i && n.isOutOfScreen(t, e), A)),
            A)
          )
            return;
          const k = this._points[0].clone();
          (k.data = 0), (k.snappingPrice = C);
          const D = new n.Point(b, m);
          (D.data = 2), (D.square = !0), (D.snappingPrice = M);
          const E = new n.Point(b, R);
          (E.data = 3), (E.square = !0), (E.snappingPrice = I);
          const B = new n.Point(S, k.y);
          (B.data = 1), (B.square = !0), (B.snappingIndex = h.index);
          const z = { points: [k, B, D, E], pointsCursorType: T };
        ...
        _createBackgroundRenderers(e, t) {
          ...
          if (e.pl < 0 && e.entryX !== e.right) {
            ...
            this._stopBgRenderer.setData(o),
          ...
          if (e.pl > 0 && e.entryX !== e.right) {
            ...
            this._targetBgRenderer.setData(o),
        ...
        _creareMiddleLabel(e, t, i) {
          const s =
              Math.abs(e.entryPrice - e.profitPrice) /
              Math.abs(e.entryPrice - e.stopPrice),
            a = this._source.properties().childs(),
            o = (0, r.ensureNotNull)(this._source.ownerSource()),
            l = new n.Point(
              (e.left + e.edge) / 2,
              Math.round(this._points[0].y),
            );
          let d = '',
            h = '';
          ...
          const u = a.qty.value() / a.lotSize.value(),
            p =
              'futures' === i.type || (0, R.isCryptoSymbol)(i)
                ? Math.round(1e3 * u) / 1e3
                : Math.floor(u);
          if (a.compact.value())
            (d += h ? h + ' ~ ' : ''), (d += p + '\n'), (d += c);
          else {
          ...
          return (
            e.pl < 0
              ? (_ = a.stopBackground.value())
              : e.pl > 0 && (_ = a.profitBackground.value()),
            ...
            (d = i.compact.value()
              ...
              : C.format({
                  ...
                  stopChangePercent: (0, x.forceLTRStr)(
                    this._percentageFormatter.format(o),
                  ),
                  stopChangePip: this._pipFormatter
                    ? (0, x.forceLTRStr)(this._pipFormatter.format(a))
                    : '',
    ...
    31677: (e, t, i) => {
      ...
      var n = i(86441).Point,
        ...
        s = i(4754).LineSourcePaneView,
        a = i(4754).thirdPointCursorType,
        o = i(9933).TrendLineRenderer,
        l = i(98930).PolygonRenderer,
        d = i(29639).CompositeRenderer,
        h = i(85113).LineEnd,
        c = i(6947).PaneCursorType;
      const { LINESTYLE_SOLID: u } = i(53479);
      t.RotatedRectanglePaneView = class extends s {
        ...
        _updateImpl() {
          if (
            ...
            var w = [];
            w.push(_), this._points.length >= 2 && w.push(g);
            ...
            l.append(
              this.createLineAnchor({ points: w, pointsCursorType: y }, 0),
            ),
              (this._renderer = l);
          }
        }
    ...
    3793: (e, t, i) => {
      'use strict';
      i.r(t), i.d(t, { SignpostPaneView: () => P });
      var n = i(86441),
        r = i(7394),
        s = i(29639),
        a = i(6947),
      ...
      class w {
        ...
        setData(e) {
          ...
          if (
            ...
            r.points = [new n.Point(e[0].x, R(t))];
          } else {
            const e =
              1 === t.direction
        ...
        hitTest(e, t) {
          ...
          const [i, r, s] = (function (e, t) {
            ...
            if (!a && void 0 !== s) {
              ...
              o =
                s.circleRadius > 0 &&
                (0, u.pointInCircle)(t, new n.Point(r, a), s.circleRadius + i);
            }
          ...
          if (i || r || s) {
            ...
            return (
              s
                ? (e.areaName = o.AreaName.Text)
                : r && (e.areaName = o.AreaName.Style),
        ...
        draw(e, t) {
          ...
          e.moveTo(o, Math.round(x(this._data) * r)),
            e.lineTo(o, Math.round(m(this._data) * r)),
            ...
            void 0 !== this._data.plate &&
              (function (e, t, i, n, r) {
                ...
                const h = (0, f.fillScaledRadius)(a, s),
                  ...
                  u = t.inverseAnchorPosition
                    ? Math.round(t.anchorY * s) +
                      Math.round(a * s) * t.direction
                    : Math.round(t.anchorY * s) +
                      Math.round((t.labelHeight + o + a) * s) * t.direction,
                ...
                const v = Math.round(i.circleBorderWidth * s),
                  x = (0, f.strokeScaledRadius)(a, s, v);
                if (
                  ((e.lineWidth = v),
                  e.beginPath(),
      ...
      class P extends l.LineSourcePaneView {
        ...
        _updateTimelineRenderer(e) {
          ...
          const a = this._model.isDark() ? b : L,
          ...
          return (
            ...
            this._signpostRenderer.setData(R),
            !0
          );
        }
        async _updateEmoji() {
          ...
          const n = (0, y.getTwemojiUrl)(t, 'svg'),
            ...
            a = { emoji: t, abortController: r };
          this._emojiCache = a;
          const [o, { svgRenderer: l }] = await Promise.all([
            s,
            i.e(2616).then(i.bind(i, 33268)),
          ]);
          !this._destroyed &&
            a.abortController &&
            ((a.emojiSvgRenderer = l(o)),
      ...
      class _ extends c.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          const { size: i, angle: n, point: s } = this._data,
            a = (0, r.rotationMatrix)(-n),
            o = (0, r.transformPoint)(a, e.subtract(s));
          return Math.abs(o.y) <= i / 2 && Math.abs(o.x) <= i / 2
            ? new u.HitTestResult(u.HitTestResult.MOVEPOINT)
            : null;
        }
        isOutOfScreen(e, t) {
      ...
      class _ extends u.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (
            ...
            o.fillBackground &&
              o.fillBackground.value() &&
              (_.backgroundColor = o.backgroundColor.value()),
            o.drawBorder &&
              o.drawBorder.value() &&
              (_.borderColor = o.borderColor.value()),
            o.wordWrap &&
              o.wordWrap.value() &&
              (_.wordWrapWidth = o.wordWrapWidth.value()),
            (_.bold = o.bold && o.bold.value()),
            (_.italic = o.italic && o.italic.value()),
    ...
    84330: (e, t, i) => {
      'use strict';
      i.r(t), i.d(t, { TrendAnglePaneView: () => b });
      var n = i(50151),
        r = i(86441),
        s = i(44352),
        a = i(80142),
        ...
        x = i(71145),
        m = i(86216);
      class R extends m.MediaCoordinatesPaneRenderer {
        constructor() {
          super(...arguments), (this._data = null);
        }
        setData(e) {
      ...
      class b extends T.AlertableLineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            ...
            (this._pipFormatter = null),
            (this._lastSymbolInfo = null),
            (this._trendRenderer = new p.TrendLineRenderer()),
            (this._angleRenderer = new R()),
            ...
            (this._iconsReady = !1),
            _.iconsContainer.onAllIconsReady().subscribe(this, () => {
        ...
        destroy() {
          this._cache && (this._cache.destroy(), (this._cache = null)),
            _.iconsContainer.onAllIconsReady().unsubscribeAll(this);
        }
        iconsReady() {
        ...
        getCacheRects(e, t) {
          const i = this._createCacheIfRequired(e),
            r = (0, n.ensureNotNull)(this._statCache),
            s = (0, n.ensureNotNull)(this._middlePoint),
            a = (0, n.ensureNotNull)(this._secondPoint),
            o = this._source.properties().childs().statsPosition.value(),
            l = this._source.getPointByPosition(o, this._points[0], s, a),
            d = {
              left: 0,
              top: i.topByRow(r.rowIndex),
              width: i.rowWidth(r.rowIndex),
              height: i.rowHeight(r.rowIndex),
            },
            h = {
              left: Math.floor(l.x),
              top: Math.floor(l.y),
          ...
          return (
            (h.left += w.LabelSettings.paddingLeftRight),
            (this._points[1].y < this._points[0].y &&
              this._points[1].x < this._points[0].x) ||
            (this._points[1].y > this._points[0].y &&
              this._points[1].x > this._points[0].x)
              ? (h.top -= w.LabelSettings.paddingLeftRight + h.height)
              : (h.top += w.LabelSettings.paddingLeftRight),
            { cacheRect: d, targetRect: h }
          );
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(e, t), this._renderer;
        ...
        _createCacheIfRequired(e) {
          return (
            (null !== this._cache &&
              ...
              (0, v.areEqualPaneRenderParams)(e, this._cacheDrawParams)) ||
              (this._cache && this._cache.destroy(),
              (this._cache = new y.TrendLineStatsCache(e)),
        ...
        _updateImpl(e, t) {
          ...
          const n = this._source.angle();
          if (this._points.length > 0 && null !== n) {
            const e = this._points[0],
              t = Math.cos(n),
              i = -Math.sin(n),
              s = new r.Point(t, i);
            (this._secondPoint = e.addScaled(s, this._source.distance())),
              (this._middlePoint = this._source.calcMiddlePoint(
                this._points[0],
                this._secondPoint,
              ));
          ...
          const _ =
              this.isHoveredSource() ||
              this.isSelectedSource() ||
              l.alwaysShowStats.value(),
            v =
              (this.isHoveredSource() || this.isSelectedSource()) &&
              l.showMiddlePoint.value();
          if (_ && 2 === this._points.length) {
            const e = new x.PaneRendererCachedImage(this, 0);
            this._renderer.append(e);
          }
          this._middlePoint &&
            this._renderer.append(
              new g.SelectionRenderer({
                ...
                color: u,
                visible: v && this.areAnchorsVisible(),
          ...
          this._angleRenderer.setData(m),
            this._renderer.append(this._angleRenderer);
          const R = Math.round((180 * m.angle) / Math.PI) + 'º',
            w = {
              points: [new r.Point(this._points[0].x + 50, this._points[0].y)],
              text: (0, a.forceLTRStr)(R),
              color: l.textcolor.value(),
              horzAlign: 'left',
          ...
          this._angleLabelRenderer.setData(w),
            ...
            p.points.length >= 2 &&
              this._addAlertRenderer(this._renderer, p.points);
          const y = new r.Point(this._secondPoint.x, this._secondPoint.y);
          (y.data = 1),
            this._renderer.append(
              this.createLineAnchor({ points: [this._points[0], y] }, 0),
            );
        }
        _statLabelData() {
          const e = this._source.points(),
          ...
          const p = o.showPriceRange.value(),
            _ = (0, n.ensureNotNull)(this._source.ownerSource());
          if (p && this._source.priceScale()) {
            const e = r.price - t.price,
              i = e / Math.abs(t.price);
            h =
              _.formatter().format(e) +
              ' (' +
              this._percentageFormatter.format(100 * i) +
              ')';
            const n = this._model.mainSeries().symbolInfo();
            n &&
              n !== this._lastSymbolInfo &&
              ((this._pipFormatter = new l.PipFormatter(
                n.pricescale,
                n.minmov,
                n.type,
                n.minmove2,
              ...
              (h += this._pipFormatter
                ? ', ' + this._pipFormatter.format(e)
                : ''),
              d.push('priceRange');
          }
          ...
          g &&
            ...
            (this._label =
              ...
              null);
          const v = this._model.isDark(),
            x = v ? w.LabelSettings.bgColorDark : w.LabelSettings.bgColorLight,
            m = v
              ? w.LabelSettings.textColorDark
              : w.LabelSettings.textColorLight,
            R = o.statsPosition.value(),
            y = {
              points: [
                this._source.getPointByPosition(
                  R,
                  this._points[0],
              ...
              isDark: v,
              font: f.CHART_FONT_FAMILY,
              fontSize: w.LabelSettings.fontSize,
              lineSpacing: w.LabelSettings.lineSpacing,
              backgroundColor: x,
              backgroundRoundRect: w.LabelSettings.rectRadius,
              paddingLeft: w.LabelSettings.paddingLeftRight,
              paddingRight: w.LabelSettings.paddingLeftRight,
              paddingTop: w.LabelSettings.paddingTopBottom,
              paddingBottom: w.LabelSettings.paddingTopBottom,
              textPadding: w.LabelSettings.textPadding,
              doNotAlignText: !0,
              icons: d,
              bold: !1,
              italic: !1,
      ...
      class u extends c.LineToolPaneViewFibWithLabels {
        ...
        _updateImpl(e, t) {
          ...
          if (3 === this._source.points().length) {
            ...
            let a = !1;
            p.reverse && p.reverse.value() && (a = p.reverse.value()),
              (this._levels = []);
            const o = a ? n.price : r.price,
              l = a ? r.price : n.price,
              h = o - l;
            let c, u, _;
            ...
            for (let i = 1; i <= x; i++) {
              ...
              const r = n.coeff.value(),
                s = n.color.value(),
                a = (0, d.fibLevelCoordinate)(f, v, r, e, t, g),
                o = (0, d.fibLevelPrice)(f, v, r, e, t, g);
              this._levels.push({
                color: s,
                price: o,
                y: a,
          ...
          const f = Math.min(g.x, u.x),
            ...
            R = p.extendLinesLeft.value(),
            w = p.extendLines.value();
          if (x)
            for (let e = 0; e < this._levels.length; e++)
              if (e > 0 && x) {
                const t = this._levels[e - 1],
          ...
          for (let i = 0; i < this._levels.length; i++) {
            ...
            null !== u &&
              ...
              'middle' === p.vertLabelsAlign.value() &&
                (c =
                  null !== (o = (0, h.getTextBoundaries)(u, e, t)) &&
                  void 0 !== o
                    ? o
                    : void 0));
            const _ = {
    ...
    48016: (e, t, i) => {
      ...
      class p extends u.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          let v = o.horzLabelsAlign.value();
          v = 'left' === v ? 'right' : 'right' === v ? 'left' : 'center';
          const x = o.vertLabelsAlign.value(),
    ...
    84070: (e, t, i) => {
      'use strict';
      i.r(t), i.d(t, { TrendLinePaneView: () => T });
      var n = i(50151),
        r = i(86441),
        s = i(44352),
        a = i(80142),
        ...
        w = i(6124),
        y = i(30739);
      class T extends R.AlertableLineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            (this._label = null),
            (this._labelData = null),
            (this._percentageFormatter = new h.PercentageFormatter()),
            (this._numericFormatter = new c.NumericFormatter()),
            (this._pipFormatter = null),
            (this._lastSymbolInfo = null),
            (this._trendRenderer = new g.TrendLineRenderer()),
            (this._labelRenderer = new d.TextRenderer()),
            (this._renderer = new l.CompositeRenderer()),
            (this._cache = null),
            (this._cacheDrawParams = null),
            (this._cacheInvalidated = !0),
            (this._statCache = null),
            (this._iconsReady = !1),
            v.iconsContainer.onAllIconsReady().subscribe(this, () => {
              this._cache && (this._cache.destroy(), (this._cache = null)),
                (this._iconsReady = !0),
                t.lightUpdate();
            });
        ...
        destroy() {
          this._cache && (this._cache.destroy(), (this._cache = null)),
            v.iconsContainer.onAllIconsReady().unsubscribeAll(this);
        }
        iconsReady() {
          return this._iconsReady;
        }
        ...
        getCacheRects(e, t) {
          ...
          return (
            (d.left += w.LabelSettings.paddingLeftRight),
            (this._points[1].y < this._points[0].y &&
              this._points[1].x < this._points[0].x) ||
            (this._points[1].y > this._points[0].y &&
              this._points[1].x > this._points[0].x)
              ? (d.top -= w.LabelSettings.paddingLeftRight + d.height)
              : (d.top += w.LabelSettings.paddingLeftRight),
            { cacheRect: l, targetRect: d }
          );
        }
        renderer(e, t) {
          return this._invalidated && this._updateImpl(e, t), this._renderer;
        ...
        _createCacheIfRequired(e) {
          return (
            (null !== this._cache &&
              null !== this._cacheDrawParams &&
              (0, f.areEqualPaneRenderParams)(e, this._cacheDrawParams)) ||
              (this._cache && this._cache.destroy(),
              (this._cache = new y.TrendLineStatsCache(e)),
              (this._statCache = this._cache.updateSource(this._source, () =>
                this._statLabelData(),
        ...
        _updateImpl(e, t) {
          ...
          if (!n || n.isEmpty() || s.isEmpty()) return;
          ...
          if (
            (v ||
              ...
              ((this._label = null),
              this._labelData && (this._labelData.text = '')),
            u.showLabel && u.showLabel.value() && u.text.value().length > 0)
          ) {
            ...
            this._labelRenderer.setData(_),
              ...
              this._needLabelExclusionPath(this._labelRenderer) &&
                (w =
                  null !==
                    (i = (0, d.getTextBoundaries)(this._labelRenderer, t, e)) &&
                  void 0 !== i
                    ? i
                    : void 0);
          }
          ...
          const b =
              ((this.isHoveredSource() || this.isSelectedSource()) &&
                this.isEditMode()) ||
              u.alwaysShowStats.value(),
            L =
              (this.isHoveredSource() || this.isSelectedSource()) &&
              u.showMiddlePoint.value();
          ...
          this._middlePoint &&
            this._renderer.append(
              new _.SelectionRenderer({
                ...
                hittestResult: m.HitTestResult.REGULAR,
                barSpacing: 0,
              }),
            ),
            this.addAnchors(this._renderer),
        ...
        _statLabelData() {
          const e = this._source.points(),
            ...
            l = [];
          let d, h, c, _, g, f, v;
          const m = o.showPriceRange.value(),
            R = (0, n.ensureNotNull)(this._source.ownerSource());
          if (m && this._source.priceScale()) {
            _ = r.price - t.price;
            const e = _ / Math.abs(t.price);
            d =
              R.formatter().format(_) +
              ' (' +
              this._percentageFormatter.format(100 * e) +
              ')';
            ...
            i &&
              ...
              (this._lastSymbolInfo = i)),
              (d += this._pipFormatter
                ? ', ' + this._pipFormatter.format(_)
                : ''),
              l.push('priceRange');
          }
          const y = o.showBarsRange.value(),
            ...
            L = o.showAngle.value();
          if (L || b) {
            const e = (0, n.ensureNotNull)(this._source.pointToScreenPoint(t));
            (f = (0, n.ensureNotNull)(
              this._source.pointToScreenPoint(r),
            ).subtract(e)),
              (v = Math.round(1e5 * f.length()) / 1e5);
          }
          if (y || T || b) {
            if (
              ((h = ''),
              y &&
                ...
                (h += s
                  .t(null, void 0, i(33355))
                  .format({ count: (0, a.forceLTRStr)(String(g)) }))),
              T)
            ) {
              const e = this._model.timeScale().indexToUserTime(t.index),
                i = this._model.timeScale().indexToUserTime(r.index);
              if (e && i) {
                const t = (i.valueOf() - e.valueOf()) / 1e3,
                  n = (0, a.startWithLTR)(new u.TimeSpanFormatter().format(t));
                n && (h += y ? ' (' + n + ')' : n);
              }
            }
            b &&
              ...
              (h += s
                ...
                .format({
                  number: (0, a.forceLTRStr)(
                    this._numericFormatter.format(Math.round(Number(v))),
                  ),
                }))),
              h && l.push('barsRange');
          }
          if (L) {
            ...
            void 0 !== v &&
              v > 0 &&
              void 0 !== f &&
              ((f = f.normalized()), (e = Math.acos(f.x)), f.y > 0 && (e = -e)),
              'number' != typeof e ||
                isNaN(e) ||
                ((c = Math.round((180 * e) / Math.PI) + 'º'), l.push('angle'));
          }
          this._label =
            [(0, a.forceLTRStr)(d), h, c].filter((e) => null != e).join('\n') ||
            null;
          const P = this._model.isDark(),
            S = P ? w.LabelSettings.bgColorDark : w.LabelSettings.bgColorLight,
            C = P
              ? w.LabelSettings.textColorDark
              : w.LabelSettings.textColorLight,
            M = {
          ...
          return (
            this._points[1].y < this._points[0].y && (M.vertAlign = 'bottom'),
            this._points[1].x < this._points[0].x && (M.horzAlign = 'right'),
            (this._labelData = M),
            M
          );
        }
      ...
      class g {
        ...
        _effectiveState(e) {
          const t = e.properties(),
            ...
            r = t.showDateTimeRange && t.showDateTimeRange.value(),
        ...
        _effectiveStatesEquals(e, t) {
          ...
          if (_(i.p1, r.p1)) return !1;
          if (_(i.p2, r.p2)) return !1;
    ...
    60548: (e, t, i) => {
      'use strict';
      var n = i(4754).LineSourcePaneView,
        r = i(29639).CompositeRenderer,
        s = i(66467).TriangleRenderer;
        ...
        _updateImpl(e, t) {
          ...
          if (
            ...
            if ('horizontal' === a.textOrientation.value()) {
              ...
              switch (
                ((r = -Math.PI / 2), (d = 0), a.horzLabelsAlign.value())
              ) {
                case 'left':
                  p = 'bottom';
                  break;
    ...
    64673: (e, t, i) => {
      ...
      function s(e, t, i, r, s, a) {
        ...
        for (let o = 0; ; o += l) {
          ...
          if (void 0 !== d) {
            if ((0, n.distanceToSegment)(p, d, s).distance < a) return !0;
    ...
    30967: (e, t, i) => {
      ...
      class u extends c.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          return null !== i && (0, a.pointInPolygon)(e, i)
            ? new d.HitTestResult(d.HitTestResult.MOVEPOINT_BACKGROUND)
            : null;
        }
        _drawImpl(e) {
          if (null === this._data) return;
        ...
        _visiblePolygon(e) {
          ...
          if (
            (0, s.equalPoints)(i, n) ||
            (0, s.equalPoints)(a, l) ||
            ((0, o.distanceToLine)(i, n, a).distance < 1e-6 &&
              (0, o.distanceToLine)(i, n, l).distance < 1e-6)
          )
            return null;
        ...
        setData(e) {
          ...
          if (
            ...
            ((0, o.distanceToLine)(t, i, n).distance < 1e-6 &&
              (0, o.distanceToLine)(t, i, r).distance < 1e-6)
          )
      ...
      class g extends p.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          for (const i of this._visiblePolygons(
            ...
            if ((0, a.pointInPolygon)(e, i))
              return new h.HitTestResult(h.HitTestResult.MOVEPOINT_BACKGROUND);
          return null;
        }
        _drawImpl(e) {
    ...
    80856: (e, t, i) => {
      ...
      class v {
        ...
        draw(e, t) {
          ...
          i.length &&
            ((e.strokeStyle = this._data.color),
            this._drawPoints(e, t.pixelRatio, i, n, _, p)),
            r.length &&
              ((e.strokeStyle = this._data.color),
        ...
        _drawPoints(e, t, i, n, r, s) {
          const o = (0, h.ensureNotNull)(this._data),
            l = o.currentPoint,
            u = o.radius;
          let p = Math.max(1, Math.floor((o.strokeWidth || 2) * t));
          o.selected && (p += Math.max(1, Math.floor(t / 2)));
          const _ = Math.max(1, Math.floor(t));
      ...
      class p extends c.MediaCoordinatesPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          const i = (0, n.size)({ width: t.cssWidth, height: t.cssHeight }),
            ...
            a = this._extendAndHitTestLineSegment(e, r, s, i);
          if (null !== a) return a;
          if (4 === this._data.points.length && !this._data.skipTopLine) {
            const [, , t, n] = this._data.points,
              a = this._extendAndHitTestLineSegment(e, t, n, i);
            if (null !== a) return a;
            if (this._data.showMidline && !this._data.skipLines) {
              const a = r.add(t).scaled(0.5),
                o = s.add(n).scaled(0.5),
                l = this._extendAndHitTestLineSegment(e, a, o, i);
              if (null !== l) return l;
            }
          }
        ...
        _drawImpl(e) {
          ...
          if (this._data.points.some((e) => !isFinite(e.y)))
            ...
            if (
              ...
              this._extendAndDrawLineSegment(t, a, o, e.mediaSize);
            }
          }
        }
        _getColor() {
        ...
        _extendAndHitTestLineSegment(e, t, i, n) {
          const r = this._extendAndClipLineSegment(t, i, n);
          if (null !== r) {
            if ((0, a.distanceToSegment)(r[0], r[1], e).distance <= 3)
        ...
        _drawBackground(e, t, i) {
          ...
          if (
            (0, s.equalPoints)(o, l) ||
            (0, s.equalPoints)(d, h) ||
            (0, a.distanceToLine)(o, l, d).distance < 1e-6 ||
            (0, a.distanceToLine)(o, l, h).distance < 1e-6
          )
            return;
    ...
    98930: (e, t, i) => {
      ...
      var n = i(34026),
        ...
        h = i(55014),
        c = i(9740);
      class u extends d.MediaCoordinatesPaneRenderer {
        constructor(e) {
          super(),
            (this._data = null),
            ...
            (this._points = []),
            (this._hittest =
              null != e ? e : new o.HitTestResult(o.HitTestResult.MOVEPOINT));
        }
        setData(e) {
          (this._data = e), (this._points = e.points);
        }
        ...
        _drawImpl(e) {
          ...
          n.beginPath();
          const o =
            null !== (t = this._data.linecap) && void 0 !== t ? t : 'butt';
          (n.lineCap = o),
    ...
    14594: (e, t, i) => {
      'use strict';
      i.d(t, { TrendLineStatsRenderer: () => R, iconsContainer: () => x });
      var n = i(27714),
        r = i(86441),
        s = i(34026),
        a = i(50151),
        ...
        x = new (class {
          constructor(e, t) {
            ...
            e.forEach((e) => {
              ...
              n.set(e.theme, new g(e.imageData, t, i)),
                this._icons.set(e.name, n);
            });
          }
          getIcon(e, t) {
            return (0, a.ensureDefined)(
              (0, a.ensureDefined)(this._icons.get(e)).get(t),
            );
          }
          onAllIconsReady() {
      ...
      class R {
        constructor(e, t, i) {
          (this._fontSize = 0),
            ...
            (this._lineSpacing =
              (0, c.isNumber)(this._data.lineSpacing) && this._data.lineSpacing
                ? this._data.lineSpacing
                : 0),
            (e.lines = this._lines =
              null === e.text
                ? []
                : (0, l.wordWrap)(e.text, this.fontStyle(), e.wordWrapWidth)),
            (this._hittest =
              i || new d.HitTestResult(d.HitTestResult.MOVEPOINT));
        }
        fontStyle() {
        ...
        draw(e, t) {
          ...
          const n = (0, a.ensureNotNull)(this._rect);
          if (this._rect) {
            if (
              ...
              let r = 0;
              const s = Math.ceil((v - this._fontSize) / 2),
                o = (0, a.ensureNotNull)(this._padding);
              for (const a of this._data.icons) {
                const l = Math.round(n.x + o.left),
                  d = Math.round(n.y + o.top + i * r - s);
                this._drawIcon(e, l, d, a, Boolean(this._data.isDark), t),
                  (r += 1);
              }
            }
          } else
          ...
          const r = (0, a.ensureNotNull)(this._textPoint),
            s = r.x;
          let o = r.y;
          e.fillStyle = this._data.color;
        ...
        hitTest(e) {
          return 0 === this._data.points.length
            ? null
            : (this._preRender(),
              this._boundingBox && (0, s.pointInBox)(e, this._boundingBox)
                ? this._hittest
                : null);
        }
        _preRender() {
          ...
          const e = (function () {
              if (null !== f) return f;
              const e = (0, u.createDisconnectedCanvas)(
                document,
                (0, n.size)({ width: 0, height: 0 }),
              );
              return (f = (0, u.getPrescaledContext2D)(e)), f;
            })(),
          ...
          if (this._data.wordWrapWidth) {
            ...
            for (let e = 0; e < this._lines.length; e++)
              h.push(this._data.wordWrapWidth);
          } else {
            c = 0;
        ...
        _drawIcon(e, t, i, n, r, s) {
          const l = `${n}${this._data.isDark}${s.pixelRatio}`;
          let d = m.get(l);
          if (!d) {
            (d = document.createElement('canvas')),
              (d.width = v * s.pixelRatio),
              (d.height = v * s.pixelRatio),
              (d.style.width = '18px'),
              (d.style.height = '18px');
            const e = (0, a.ensureNotNull)(d.getContext('2d'));
            e.setTransform(1, 0, 0, 1, 0, 0),
              o.isEdge || e.scale(s.pixelRatio, s.pixelRatio);
            const t = x.getIcon(n, r ? 'dark' : 'light');
            t.ready() && (e.drawImage(t.image(), 0, 0), m.set(l, d));
          }
          e.drawImage(d, t - 0.5, i - 0.5, v, v);
        }
      }
    },
    66467: (e, t, i) => {
      ...
      var n = i(4652),
        ...
        l = i(55014),
        d = i(9740);
      class h extends s.MediaCoordinatesPaneRenderer {
        constructor() {
          super(...arguments), (this._data = null);
        }
        setData(e) {
    ...
    438: (e) => {
      e.exports = {
        ...
        ms_MY: [
          'Berhenti: {stopChange} ({stopChangePercent}) {stopChangePip}, Amaun: {amount}',
        ],
        nl_NL:
    ...
    15166: (e) => {
      e.exports = {
        ...
        ms_MY: [
          'Sasaran: {profitChange} ({profitChangePercent}) {profitChangePip}, Amaun: {amount}',
        ],
        nl_NL:
