(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8483],
  {
    ...
    53282: (e) => {
      e.exports = {
        itemRow: 'itemRow-lJFqnNjL',
        favoriteButton: 'favoriteButton-lJFqnNjL',
        active: 'active-lJFqnNjL',
        selected: 'selected-lJFqnNjL',
        mobile: 'mobile-lJFqnNjL',
        itemInfo: 'itemInfo-lJFqnNjL',
        title: 'title-lJFqnNjL',
        details: 'details-lJFqnNjL',
        itemInfoWithPadding: 'itemInfoWithPadding-lJFqnNjL',
        favorite: 'favorite-lJFqnNjL',
        removeButton: 'removeButton-lJFqnNjL',
      };
    },
    24810: (e) => {
      e.exports = {
    ...
    74292: (e) => {
      e.exports = { scrollWrap: 'scrollWrap-Lt5uPNKI' };
    },
    82461: (e) => {
      e.exports = {
        wrap: 'wrap-cbCWDq_M',
    ...
    75208: (e, t, n) => {
      ...
      function N(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            'div',
            { className: l()(C.container, h, (o || v) && C.unsetAlign) },
            c,
            r.createElement(
              'div',
              ...
              r.createElement(
                'div',
                { className: l()(n ? C.textWrap : C.ellipsis) },
                t,
              ),
              o &&
                r.createElement(
      ...
      class L extends r.PureComponent {
              ...
              if (!e.defaultPrevented) {
                if (
                  ...
                  if (null !== n) {
                    ...
                    if ((0, s.isTextEditingField)(n)) return void r.focus();
                    if (r.contains(n))
                      return (
                        this.props.onKeyboardClose &&
                          this.props.onKeyboardClose(),
        ...
        render() {
          const {
            ...
            J = 'after' !== p ? m : void 0,
            j = 'after' === p ? m : void 0,
            q = 'string' == typeof i ? i : M || '',
            K = (0, E.mergeRefs)([this._handleReference, B]);
          return r.createElement(
            h.MatchMedia,
    ...
    64530: (e, t, n) => {
      ...
      function d(e) {
        ...
        return r.createElement(
          ...
          C &&
            v &&
            r.createElement(a.FavoriteButton, {
              className: i()(
                u.favoriteButton,
                g && u.favorite,
          ...
          r.createElement(s.RemoveButton, {
    ...
    3085: (e, t, n) => {
      ...
      function u(e) {
        ...
        return r.createElement(
          'div',
          {
            ...
            onMouseDown: function (e) {
              ...
              E.current = (h ? r.width : r.height) / 2;
              const o = n - t;
              let i =
                x(e.nativeEvent, (0, l.ensureNotNull)(g.current)) - E.current;
              i < 0
                ? ((i = 0),
                  (E.current = x(
                    e.nativeEvent,
                    (0, l.ensureNotNull)(g.current),
                  )))
                : i > o * w * L &&
                  ((i = o * w * L),
                  (E.current =
                    x(e.nativeEvent, (0, l.ensureNotNull)(g.current)) - i));
              d(i / w / L), N(!0);
            },
          },
          r.createElement(
            'div',
            {
              ...
              style: {
                ...
                [h ? 'width' : 'height']: k,
                transform: `translate${h ? 'X' : 'Y'}(${D * w * L || 0}px)`,
              },
              onMouseDown: function (e) {
                e.preventDefault(),
                  (E.current = x(
        ...
        function P(e) {
          const t = x(e, (0, l.ensureNotNull)(g.current)) - E.current;
          d(t / w / L);
        }
        function S(e) {
          N(!1);
