(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4013],
  {
    ...
    94720: (e, t, n) => {
      ...
      function c(e) {
        const {
          ...
          })((0, l.getGroupCellRemoveRoundBorders)(m));
        return r(
          h,
          a().button,
          a()[`size-${n}`],
      ...
      function u(e) {
        ...
        return o.createElement(
          ...
          l && o.createElement('span', { className: a().content }, l),
          i &&
            !r &&
            o.createElement(s.Icon, {
              icon: i,
    ...
    67029: (e, t, n) => {
      'use strict';
      n.d(t, { ControlSkeleton: () => g, InputClasses: () => f });
      var o = n(50959),
        r = n(97754),
        l = n(50151),
        s = n(38528),
      ...
      function p(e, t, n, o) {
        const {
          ...
          C = h(null != l ? l : (0, c.getGroupCellRemoveRoundBorders)(n));
        return r(
          d().container,
          d()[`intent-${i}`],
          d()[`border-${a}`],
      ...
      function m(e, t) {
        ...
        const l = h(null != o ? o : (0, c.getGroupCellRemoveRoundBorders)(t));
      ...
      function v(e, t) {
        ...
        return o.createElement(
          ...
          S,
          x,
          o.createElement('span', { className: m(e, M) }),
        );
      }
      v.displayName = 'ControlSkeleton';
      const g = o.forwardRef(v);
    },
    78274: (e, t, n) => {
      'use strict';
      n.d(t, {
    ...
    31261: (e, t, n) => {
      ...
      function v(e) {
        const {
          ...
          J = (0, l.filterProps)(j, b),
          Q = {
            ...(0, l.filterAriaProps)(j),
            ...(0, l.filterDataProps)(j),
            id: t,
            title: n,
            role: s,
            tabIndex: i,
      ...
      function g(e) {
        ...
        const {
          ...
          E = (0, s.createSafeMulticastEventHandler)(
            C.onFocus,
            function (e) {
              n && !S.current && (0, i.selectAllContent)(e.currentTarget);
            },
            l,
          ),
          O = (0, s.createSafeMulticastEventHandler)(C.onBlur, h),
          M = (0, o.useCallback)(
            (e) => {
              (f.current = e),
                p &&
          ...
          { isFocused: u, ...d } = (function (e) {
            const {
              ...
              y = (0, o.useCallback)(
                (e) => {
                  var t;
                  return null === (t = _.current) || void 0 === t
                    ? void 0
                    : t.focus(e);
                },
                [_],
              ...
              S = (0, o.useRef)(null),
              x = (0, o.useCallback)(
                () => (0, r.ensureNotNull)(S.current).focus(),
                [S],
              ),
              ...
              k = c ? [] : [h, v.onBlur],
              B = c ? [] : [p, O],
              T = (0, i.createSafeMulticastEventHandler)(...M),
              N = (0, i.createSafeMulticastEventHandler)(...k),
              A = (0, i.createSafeMulticastEventHandler)(...B);
            return {
              listboxId: C,
              isOpened: m,
              isFocused: g,
              ...
              toggle: O,
              onOpen: x,
              buttonFocusBindings: { onFocus: T, onBlur: N },
              onButtonClick: A,
              buttonRef: _,
              listboxRef: S,
              buttonAria: {
    ...
    53017: (e, t, n) => {
      ...
      n.d(t, { mergeRefs: () => o, isomorphicRef: () => r });
    },
    47201: (e, t, n) => {
      'use strict';
      function o(...e) {
                ...
                o.createElement(
                  ...
                  m &&
                    o.createElement(
                      ...
                      null != p ? p : a.t(null, void 0, n(20036)),
                    ),
                  o.createElement(
                    'span',
    ...
    75208: (e, t, n) => {
      ...
      var m = n(52092),
        f = n(76422),
        b = n(9745);
      const v = o.createContext({ setHideClose: () => {} });
      var g = n(7720),
        C = n(24810);
      function _(e) {
        const {
        ...
        return o.createElement(
          ...
          o.createElement(
            'div',
            { className: s()(C.container, h, (r || p) && C.unsetAlign) },
            c,
            o.createElement(
              'div',
              ...
              o.createElement(
                'div',
                { className: s()(n ? C.textWrap : C.ellipsis) },
                t,
              ),
              r &&
                o.createElement(
      ...
      class E extends o.PureComponent {
              ...
              if (!e.defaultPrevented) {
                if (
                  ...
                  if (null !== n) {
                    ...
                    if ((0, a.isTextEditingField)(n)) return void o.focus();
                    if (o.contains(n))
                      return (
                        this.props.onKeyboardClose &&
                          this.props.onKeyboardClose(),
        ...
        render() {
          const {
            ...
            Y = 'after' !== f ? b : void 0,
            q = 'after' === f ? b : void 0,
            W = 'string' == typeof l ? l : R || '',
            j = (0, y.mergeRefs)([this._handleReference, F]);
          return o.createElement(
            h.MatchMedia,
                ...
                (d) =>
                  o.createElement(
                    ...
                    o.createElement(
                      ...
                      o.createElement(p.PopupContext.Consumer, null, (e) =>
                        this._renderChildren(e, d || M),
                      ),
                    ),
                  ),
              ),
    ...
    46059: (e, t, n) => {
        ...
        return (0, o.useCallback)(
          () =>
            (function (e, t, { x: n = d.x, y: o = d.y } = d) {
              ...
              return t && (l.overrideWidth = r.width), l;
            })(e.current, t, n),
          [e, t],
        );
      }
      const p = JSON.parse('{"size-header-height":"64px"}'),
        m = parseInt(p['size-header-height']);
      function f(e) {
        const {
            button: t,
            popupChildren: n,
      ...
      function C(e) {
        ...
        return o.createElement(b.Icon, {
          className: l()(g.icon, t && g.dropped),
          icon: v,
        });
      }
      function _(e) {
        ...
        return o.createElement(
          'span',
          { className: l()(g.button, n && g.disabled, t) },
      ...
      const S = o.forwardRef((e, t) => {
        const {
          ...
          R =
            ...
            o.createElement(
              a.EndSlot,
              null,
              o.createElement(_, { isDropped: b, disabled: m, className: N }),
            );
        return o.createElement(f, {
          ...
          button: o.createElement(i.ControlSkeleton, {
            ...
            'data-role': 'listbox',
            disabled: m,
            className: l()(y.button, r),
            size: x,
            ref: (0, s.useMergedRefs)([D, t]),
            middleSlot: o.createElement(
              a.MiddleSlot,
              null,
              o.createElement(
                'span',
                { className: l()(y['button-children'], d && y.hiddenArrow) },
                B,
              ),
            ),
            endSlot: R,
      ...
      S.displayName = 'ControlDisclosureView';
    },
    26597: (e, t, n) => {
      'use strict';
      n.d(t, {
    ...
    75690: (e, t, n) => {
        ...
        return (function (e) {
          ...
          return (
            (f = window.requestAnimationFrame(function e(t) {
              let l;
              if ((m ? (l = t - m) : ((l = 0), (m = t)), l >= n))
                return (s[h] = p + d), void (r && r());
              const i = p + d * o(l / n);
              (s[h] = Math.floor(i)), (f = window.requestAnimationFrame(e));
            })),
            function () {
        ...
        const { activeItem: t, getKey: n, ...r } = e,
          ...
          p = (0, o.useCallback)(
            (e, t) => {
              ...
              const o = n ? n(e) : e,
                r = i.current.get(o);
              r && (c(), (0, s.ensureNotNull)(a.current).scrollTo(r, t));
            },
            [i, a, n],
          );
        return (0, o.useEffect)(() => p(t, r), [p, t]), [u, d, p];
      }
      var m = n(16396),
        f = n(4889),
        b = n(43370);
      ...
      function O(e) {
        var t, n;
        const { selectedItem: r, placeholder: l } = e;
        if (!r) return o.createElement('span', { className: x.placeholder }, l);
        const s =
          null !==
            (n =
      ...
      const M = o.forwardRef((e, t) => {
        ...
        const {
            ...
            close: U,
            toggle: G,
            buttonFocusBindings: V,
            onButtonClick: X,
            buttonRef: $,
            listboxRef: Z,
            buttonAria: ee,
          } = (0, y.useControlDisclosure)({
            id: n,
            disabled: c,
            buttonTabIndex: a,
            intent: d,
          ...
          te = F.filter(w),
          ne = te.find((e) => e.value === k),
          [oe, re, le] = p({ activeItem: ne }),
          se = (0, r.joinDomIds)(B, n),
          ie = se.length > 0 ? se : void 0,
          ae = (0, o.useMemo)(
            () => ({
              role: 'listbox',
              'aria-labelledby': B,
              'aria-activedescendant': E(n, ne),
            }),
            [B, ne],
          ),
          ce = (0, o.useCallback)((e) => e.value === k, [k]),
          ue = (0, o.useCallback)((e) => I && I(e.value), [I]),
          de = (function (e, t, n, r, l, s = {}, i) {
            const a = (0, o.useCallback)(
                (e) => {
                  const o = t.findIndex(n);
                  if (o === t.length - 1 && !l)
                    return void (
                      (null == i ? void 0 : i.onFailNext) && i.onFailNext(e)
                    );
                  const s = g(o + 1, t.length);
                  r && r(t[s], 'next');
                },
                [t, n, r, l],
              ),
              c = (0, o.useCallback)(
                (e) => {
                  ...
                  if (0 === o && !l)
                    return void (
                      (null == i ? void 0 : i.onFailPrev) && i.onFailPrev(e)
                    );
                  const s = g(o - 1, t.length);
                  r && r(t[s], 'previous');
                },
              ...
              {
                next: p = h.next,
                previous: m = h.previous,
                first: f = h.first,
                last: b = h.last,
              } = s;
            return (0, v.useComposedKeyboardActionHandlers)(
              (0, v.useKeyboardActionHandler)(p, a),
              (0, v.useKeyboardActionHandler)(m, c),
              (0, v.useKeyboardActionHandler)(f, u),
              (0, v.useKeyboardActionHandler)(b, d),
            );
          })(S.isRtl, te, ce, ue, !1, {
            next: [40],
            previous: [38],
          }),
          he = (0, C.useKeyboardToggle)(G, L || z),
          pe = (0, C.useKeyboardClose)(L, U),
          me = (0, C.useKeyboardOpen)(L, J),
          fe = (0, C.useKeyboardEventHandler)([he, pe, me]),
          be = (0, C.useKeyboardEventHandler)([de, he, pe]),
          ve = (function (e) {
            const t = (0, o.useRef)(''),
              n = (0, o.useMemo)(
                () =>
              ...
              r = (0, o.useMemo)(() => (0, b.default)(e, 200), [e]);
            return (0, o.useCallback)(
              (e) => {
                e.key.length > 0 &&
                  e.key.length < 3 &&
            ...
            void 0 !== o && I && (n.stopPropagation(), L || J(), I(o.value));
          });
        return o.createElement(
          _.ControlDisclosureView,
          {
            ...K,
            ...ee,
            ...V,
            ...
            onListboxKeyDown: function (e) {
              be(e), e.defaultPrevented || ve(e);
            },
            buttonChildren: o.createElement(O, {
              selectedItem: ne,
              placeholder: x,
            }),
    ...
    1109: (e, t, n) => {
      ...
      function s(e) {
        return o.createElement('div', {
          className: r(l.separator, e.className),
        });
      }
    },
    3810: (e) => {
      e.exports = {
        scrollable: 'scrollable-PSZ_D1q_',
        content: 'content-PSZ_D1q_',
        row: 'row-PSZ_D1q_',
        title: 'title-PSZ_D1q_',
        control: 'control-PSZ_D1q_',
      };
    },
    66735: (e, t, n) => {
      'use strict';
          ...
          o.createElement(l.AdaptiveConfirmDialog, {
            ...
            render: () =>
              o.createElement(
                ...
                { className: d.scrollable, onScroll: _ },
                o.createElement(
                  'div',
                  { className: d.content },
                  o.createElement(
            ...
            submitButtonText: r.t(null, void 0, n(54777)),
            submitOnEnterKey: !1,
            fullScreen: !0,
          })
        );
