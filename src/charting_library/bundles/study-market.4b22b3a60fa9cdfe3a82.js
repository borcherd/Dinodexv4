(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [6456],
  {
    ...
    42748: (e) => {
      e.exports = { container: 'container-soqunFTo' };
    },
    73154: (e) => {
      e.exports = {
    ...
    28124: (e) => {
      e.exports = {
        ...
        'highlight-animation-theme-light':
          'highlight-animation-theme-light-YSK4uslt',
        dark: 'dark-YSK4uslt',
        'highlight-animation-theme-dark':
          'highlight-animation-theme-dark-YSK4uslt',
    ...
    48019: (e) => {
      e.exports = { container: 'container-Y8R6tAt1' };
    },
    74781: (e) => {
      e.exports = {
        'tablet-small-breakpoint': 'screen and (max-width: 430px)',
    ...
    53017: (e, t, n) => {
      ...
      n.d(t, { mergeRefs: () => r, isomorphicRef: () => i });
    },
    39640: (e, t, n) => {
      'use strict';
    ...
    75208: (e, t, n) => {
      ...
      function b(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            'div',
            { className: a()(_.container, h, (i || p) && _.unsetAlign) },
            c,
            r.createElement(
              'div',
              ...
              r.createElement(
                'div',
                { className: a()(n ? _.textWrap : _.ellipsis) },
                t,
              ),
              i &&
                r.createElement(
      ...
      class k extends r.PureComponent {
        ...
        render() {
          const {
            ...
            H = 'after' !== m ? v : void 0,
            j = 'after' === m ? v : void 0,
            q = 'string' == typeof o ? o : A || '',
            V = (0, S.mergeRefs)([this._handleReference, M]);
          return r.createElement(
            h.MatchMedia,
    ...
    69654: (e, t, n) => {
      ...
      function u(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            'div',
            { className: o()(c.inputContainer, u && c.withCancel) },
            i || r.createElement(d, { ...p }),
          ),
          t,
          r.createElement(s.Icon, { className: c.icon, icon: l }),
          u &&
            r.createElement(
              'div',
    ...
    22265: (e, t, n) => {
      ...
      function u(e) {
        const { mode: t, className: n, ...i } = e,
          ...
          u = o()(l.container, s && l.isTablet, a && l.isMobile, n);
      ...
      function h(e) {
        ...
        return r.createElement(
          ...
          r.createElement(a.Icon, { className: l.icon, icon: i }),
          !f &&
            r.createElement(
              'span',
              { className: l.title },
              r.createElement('span', { className: l.titleText }, n),
              p && r.createElement(a.Icon, { className: l.nested, icon: s }),
            ),
        );
      }
    },
    85634: (e, t, n) => {
      ...
      function h(e) {
        ...
        const {
          ...
          f =
            l.enabled('graying_disabled_tools_enabled') &&
            (null === (t = window.ChartApiInstance) || void 0 === t
              ? void 0
              : t.studiesAccessController.isToolGrayed(i)),
          m = (null == h ? void 0 : h.isAuto)
            ? 'auto-java'
            : s.StudyMetaInfo.getPackageName(r);
        return {
          id: r,
          title: c || o.t(i, { context: 'study' }, n(68716)),
          shortDescription: a,
          shortTitle: a,
          isStrategy: s.StudyMetaInfo.isScriptStrategy(e),
          isHidden: u,
      ...
      function E(e) {
        ...
        return r.createElement(
          'span',
          { className: f()(w.title, i && w.disabled, n) },
          t,
        );
      }
      ...
      function D(e) {
        ...
        const i = (0, r.useContext)(C),
          ...
          { isFavorite: b, isLocked: S, public: w, editorsPick: O } = l,
          D = void 0 !== b,
          B = P(y, l),
          A = (0, r.useCallback)((e) => e.stopPropagation(), []),
          L =
            null !== (t = e.favoriteClickHandler) && void 0 !== t
              ? t
              : (null == i ? void 0 : i.toggleFavorite)
              ? P(i.toggleFavorite, l)
              : void 0,
          z =
            (0, x.useWatchedValueReadonly)({ watchedValue: N.watchedTheme }) ===
            I.StdTheme.Dark
              ? R.dark
              : R.light,
          M = f()(
            R.container,
            l.isGrayed && R.disabled,
            m && R.selected,
            v && R.highlighted,
            v && z,
          );
        return r.createElement(
          ...
          r.createElement(
            'div',
            { className: f()(R.main, !D && R.paddingLeft) },
            D &&
              r.createElement(T.FavoriteButton, {
                className: f()(R.favorite, b && R.isActive),
                isFilled: b,
                onClick: L,
              }),
            r.createElement(
              E,
              { disabled: l.isGrayed },
              r.createElement(k.HighlightedText, {
                queryString: c,
                rules: u,
                text: l.title,
              }),
          ...
          'mobile' !== s &&
            w &&
            r.createElement('span', { className: R.likes }, w.likesCount),
          !1,
        );
      }
      function P(e, t) {
        return (n) => {
          const r = 0 === (0, O.modifiersFromEvent)(n) && 0 === n.button;
      ...
      function z(e) {
        ...
        return r.createElement('div', { style: t, className: L.container }, n);
      }
      var M = n(9745),
        F = n(94720),
        K = n(72502);
      function W(e) {
        ...
        return r.createElement(
          'div',
          { className: f()(K.container, t) },
          n && r.createElement(M.Icon, { icon: n, className: K.image }),
          i && r.createElement('h3', { className: K.title }, i),
          o && r.createElement('p', { className: K.description }, o),
          a &&
            s &&
            r.createElement(F.Button, { onClick: s, className: K.button }, a),
        );
      }
      function H(e) {
      ...
      function X(e) {
        return -1 === ee(e)
          ? ((function (e) {
              !Z(e) && (Q.push(e), ne(), G.fire(e));
            })(e),
            !0)
          : ((function (e) {
              const t = ee(e);
              -1 !== t && (Q.splice(t, 1), ne(), U.fire(e));
            })(e),
            !1);
      }
      function Z(e) {
      ...
      function te() {
        ...
        Q = [];
        const n = Boolean(
            void 0 === (0, $.getValue)('chart.favoriteLibraryIndicators'),
          ),
          r = (0, $.getJSON)('chart.favoriteLibraryIndicators', []);
        if (
          (Q.push(...r), 0 === Q.length && n && 'undefined' != typeof window)
        ) {
          const n = JSON.parse(
            null !==
              (t =
          ...
          n && Array.isArray(n) && Q.push(...n);
        }
        J.fire();
      }
      function ne() {
        const e = Q.slice();
        (0, $.setJSON)('chart.favoriteLibraryIndicators', e);
      }
      function re(e) {
        const {
            reference: t,
          ...
          [c, u] = (0, r.useState)(''),
          h = (0, r.useMemo)(() => (0, j.createRegExpList)(c, d), [c]),
          p = (0, r.useMemo)(
            () =>
              c
                ? (0, j.rankedSearch)({
            ...
            return (
              ...
              ),
              {
                ...
                handleKeyDown: function (e) {
                  ...
                  if (
                    (40 === (0, O.hashFromEvent)(e) &&
                      (e.preventDefault(), h(), m(r)),
                    38 === (0, O.hashFromEvent)(e) &&
                      (e.preventDefault(), p(), m(t)),
                    13 === (0, O.hashFromEvent)(e) && u)
                  ) {
                    if (!n) return;
                    n(u), s(u);
                  }
        ...
        return (
          ...
          r.createElement(v.AdaptivePopupDialog, {
            isOpened: a,
            onClose: s,
            onClickOutside: s,
            className: f()(q.dialogLibrary),
            render: function () {
              return r.createElement(
                r.Fragment,
                null,
                r.createElement(y.DialogSearch, {
                  reference: k,
                ...
                r.createElement(
                  _.DialogSidebarWrapper,
                  null,
                  r.createElement(
                    S,
                    { reference: C, className: q.scroll },
                    I
                      ? r.createElement(m.Spinner, null)
                      : p.length
                      ? r.createElement(
                          r.Fragment,
                          null,
                          ...
                          p
                            ...
                            .sort(ie)
                            .map((e) => {
                              const t = (null == w ? void 0 : w.id) === e.id;
      ...
      class ce extends class {
          ...
          e.isGrayed
            ...
            : (g.CheckMobile.any() ||
              ...
              (async function (e, t, n, r, i) {
                ...
                if ('java' === l.type) {
                  const e = (0, c.tryFindStudyLineToolNameByStudyId)(l.studyId);
        ...
        async _init() {
          const e = (function (e) {
            ...
            })((await this._requestBuiltInJavaStudies()).map(h)),
          );
          (this._indicatorData = await (async function (e, t) {
            ...
            G.subscribe(null, () => this._refreshFavorites()),
            U.subscribe(null, () => this._refreshFavorites());
        }
        _setFavorites() {
          l.enabled('items_favoriting') &&
            this._indicatorData.forEach((e) => {
              e.isFavorite = Z(e.title);
            });
        }
        _refreshFavorites() {
        ...
        _render() {
          ...
          i.render(r.createElement(re, { ...e }), t);
        }
      }
    },
    36189: (e, t, n) => {
    ...
    95257: (e, t) => {
      ...
      function k(e, t, r) {
        ...
        if (null != t)
          ...
          t))
            w.call(t, i) && !C.hasOwnProperty(i) && (o[i] = t[i]);
