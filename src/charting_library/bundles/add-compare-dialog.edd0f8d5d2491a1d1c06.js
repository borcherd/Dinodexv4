(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [731],
  {
    ...
    89776: (e) => {
      e.exports = {
        wrap: 'wrap-Z2IeU8oL',
        header: 'header-Z2IeU8oL',
        item: 'item-Z2IeU8oL',
      };
    },
    49083: (e) => {
      e.exports = { label: 'label-RJd3G5_Y' };
    },
    59409: (e) => {
      e.exports = {
        scrollable: 'scrollable-pnhleBGm',
        spinnerWrap: 'spinnerWrap-pnhleBGm',
        item: 'item-pnhleBGm',
        heading: 'heading-pnhleBGm',
        checkboxWrap: 'checkboxWrap-pnhleBGm',
        checkbox: 'checkbox-pnhleBGm',
        emptyState: 'emptyState-pnhleBGm',
        image: 'image-pnhleBGm',
        text: 'text-pnhleBGm',
      };
    },
    98593: (e) => {
      e.exports = { dialog: 'dialog-dvJt_v2j', tablet: 'tablet-dvJt_v2j' };
    },
    45966: (e) => {
      e.exports = {
      ...
      function c(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            'span',
            { className: t },
            r.createElement(n.Icon, { icon: s, className: l().icon }),
          ),
        );
      }
    },
    ...
    89035: (e, t, o) => {
      ...
      function L(e) {
        ...
        return d
          ? r.createElement(
              ...
              r.createElement(
                C.Drawer,
                { position: 'Bottom', onClose: L.bind(null, !1) },
                r.createElement(
                  'div',
                  { className: D.header },
                  a.t(null, void 0, o(79589)),
                ),
                r.createElement(x.PopupMenuItem, {
                  className: D.item,
                  onClick: B,
                  onClickArg: E,
                  label: N,
        ...
        function B(e, o) {
          if ((o.preventDefault(), h && t && void 0 !== e)) {
            (0, i.getSymbolSearchCompleteOverrideFunction)()(t).then((t) => {
              h.applyStudy(t.symbol, e, f), v(''), L(!0);
            });
          }
        }
      }
      function B(e) {
        const {
          ...
          [N, z] = (0, r.useState)(!1),
          D = (0, r.useRef)(null),
          T = (0, _.useAccurateHover)(D),
          B = (0, r.useMemo)(() => ({ callback: P }), [P]),
          A = !Boolean(a) && !Boolean(s),
          R = l === x;
        return r.createElement(
          w.Provider,
          { value: B },
          r.createElement(g.SymbolSearchDialogContentItem, {
            hideMarkedListFlag: 'compare' === b,
            ...e,
            reference: D,
            onClick: function (t) {
              if (Boolean(a) && l && !c) return t.preventDefault(), void m(l);
              if (!N && u) return void z(!0);
              if (h && e.onClick) return void e.onClick(t);
              if ((n.mobiletouch ? R : !N) && o) {
                (0, i.getSymbolSearchCompleteOverrideFunction)()(o).then(
                  (e) => {
                    ...
                    f.applyStudy(e.symbol, t, E);
                  },
                ),
                  C(''),
                  I && I(p, v);
              }
              n.mobiletouch && !u && !R && l && C(l);
            },
            hoverComponent: (function () {
              if (!A) return !1;
              if (u) return N;
              if (n.mobiletouch) return R;
              return Boolean(T || t);
            })()
              ? L
              : void 0,
      ...
      function O(e) {
        const { handleListWidth: t } = (0, d.ensureNotNull)(
            (0, r.useContext)(y.SymbolSearchItemsDialogContext),
          ),
          {
            compareModel: n,
            ...
            (e) =>
              r.createElement(
                ...
                (function () {
                  ...
                  if (!Boolean(w.length) && !Boolean(x.length)) {
                    const e =
                      b.watchedTheme.value() === v.StdTheme.Dark ? R : A;
                    return r.createElement(
                      'div',
                      { className: W.emptyState },
                      r.createElement(u.Icon, { className: W.image, icon: e }),
                      r.createElement(
                        'div',
                        { className: W.text },
                      ...
                      r.createElement(
                        ...
                        x.map((e) =>
                          r.createElement(B, {
                            ...
                            className: c()(W.item, e.id === k && W.highlighted),
                            key: e.id,
                            id: e.id,
                            shortName: e.title,
                            logoId: e.logoId,
          ...
          super(e),
            ...
            (this.state = {
              ...
              allowExtendTimeScale: Boolean(
                H.getBool('showAddSymbolDialog.extendCheckboxState'),
              ),
            });
        }
        render() {
      ...
      var U = o(68335),
        Y = o(75208),
        F = o(98593);
      const K = Object.keys(M.CompareOption).length / 2;
      function V(e) {
        const {
            openedItems: t,
            searchRef: o,
          ...
          } = (0, k.useEnsuredContext)(y.SymbolSearchItemsDialogContext),
          {
            ...
            hoveredItemId: g,
            setHoveredItemId: _,
            selectedCompareOption: w,
            setSelectedCompareOption: x,
          ...
          M = (0, h.useWatchedValueReadonly)({ watchedValue: f.studies() }),
          D = a[n],
          T = 'compare' === c;
        return (
          (0, r.useEffect)(() => {
          ...
          r.createElement(Y.AdaptivePopupDialog, {
            ...e,
            className: l(F.dialog, !m && p && F.tablet),
            onKeyDown: function (e) {
              var r;
              const l = (0, U.hashFromEvent)(e),
                c = T ? C : n,
                u = T ? M : a;
              switch (l) {
                case 38:
                  if ((e.preventDefault(), 0 === c)) return;
                  if (-1 === c) return void L(0);
                  L(c - 1);
                  break;
                case 40:
      ...
      var q = o(962),
        Z = o(98925),
        Q = o(88279);
      class G extends Q.DialogRenderer {
        constructor(e) {
          super(), (this._props = e);
        }
        show() {
          if (this.visible().value()) return;
          const e = r.createElement(Z.SymbolSearchItemsDialog, {
            ...this._props,
      ...
      function ee(e) {
        const { searchRef: t, setMode: o } = (0, k.useEnsuredContext)(
          ...
          { currentMode: a } = (0, k.useEnsuredContext)(
            X.SymbolSearchDialogBodyContext,
          );
        return (
          (0, r.useEffect)(() => {
            const e = t.current;
          ...
          r.createElement(J.DialogSearch, { ...e })
        );
        function n() {
          var e, r, n, s;
          t.current &&
      ...
      function se(e) {
        return new G({
          wrapper:
            ((t = e), (e) => r.createElement(j, { ...e, compareModel: t })),
          dialog: V,
          contentItem: B,
          initialScreen: O,
          searchInput: ee,
    ...
    41590: (e, t, o) => {
      ...
      function m(e) {
        const {
          ...
          [b] = (0, r.useState)(() => (0, s.randomHash)()),
          f = (0, r.useRef)(null),
          y = (0, r.useContext)(c.CloseDelegateContext);
        return (
          (0, r.useLayoutEffect)(
            () => (
              (0, a.ensureNotNull)(f.current).focus({ preventScroll: !0 }),
              y.subscribe(v, o),
              v.addDrawer(b),
              () => {
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                {
                  className: n(u.drawer, p.drawer, u[`position${t}`], h),
                  tabIndex: -1,
                  ref: f,
      ...
      function u(e) {
        ...
        return r.createElement(
          U,
          {
            ...
            'aria-selected': u,
            'aria-checked': m,
            className: a(h, A.item, g && A.withIcon, {
              [A.isActive]: S,
              [A.isDisabled]: _ || w,
              [A.hovered]: k,
            }),
          ...
          r.createElement(
            ...
            r.createElement('span', { className: a(A.label, b) }, x),
          ),
          (void 0 !== f || y) &&
            r.createElement(
              'span',
    ...
    29673: (e) => {
      e.exports = {
        ...
        pt: ['Nenhuma bolsa corresponde ao seu critério'],
