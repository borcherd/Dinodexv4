!(function (t, e) {
  ...
  function r(t, e) {
    ...
    const o = new URL(`${t || ''}`, location.href).href,
      r = JSON.parse(
        '["bundles/runtime.9e6a94224bc7334ac8fa.js","bundles/__LANG__.7076.5055b5f097e7204685ed.js","bundles/7717.8f75bd75d4b6ed45f3ff.css","bundles/7717.8f75bd75d4b6ed45f3ff.rtl.css","bundles/4618.e46ad0a894862e22afb5.js","bundles/library.4350c821a355451bc08e.js","bundles/EuclidCircular.be8f862db48c2976009f.woff2"]',
      ),
      a = encodeURIComponent(e),
      d =
        null !== (n = i.find((t) => t.language === a)) && void 0 !== n
          ? n
          : { iso: 'en', dir: 'ltr' },
  ...
  const d = class {
      ...
      (null === (i = t.overrides) || void 0 === i
        ...
        this._options.debug &&
          (o ||
            ((o = !0),
            console.log(
              'Using CL v24.004 (internal id 8ab257ed @ 2023-04-24T19:22:25.354Z)',
            ))),
        this._create();
    }
    setDebugMode(t) {
    ...
    _render(t) {
      ...
      const n = r(this._options.library_path || '', this._options.locale);
