(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [4862],
  {
    ...
    79727: (e) => {
      e.exports = {
        'round-tabs': 'round-tabs-xmC1yG0w',
        'align-start': 'align-start-xmC1yG0w',
        'align-center': 'align-center-xmC1yG0w',
        tab: 'tab-xmC1yG0w',
        'tab-primary': 'tab-primary-xmC1yG0w',
        checked: 'checked-xmC1yG0w',
        'tab-ghost': 'tab-ghost-xmC1yG0w',
        'size-xsmall': 'size-xsmall-xmC1yG0w',
        'size-small': 'size-small-xmC1yG0w',
        'size-large': 'size-large-xmC1yG0w',
      };
    },
    20577: (e) => {
      e.exports = {
    ...
    11069: (e) => {
      e.exports = {
        title: 'title-jLgqBxUH',
        tabs: 'tabs-jLgqBxUH',
        empty: 'empty-jLgqBxUH',
        image: 'image-jLgqBxUH',
        spinner: 'spinner-jLgqBxUH',
        contentList: 'contentList-jLgqBxUH',
      };
    },
    84578: (e) => {
      e.exports = { dialog: 'dialog-U4wVKi9O', button: 'button-U4wVKi9O' };
    },
    64535: (e) => {
      e.exports = {
        title: 'title-mrMP8kUe',
        withoutIcon: 'withoutIcon-mrMP8kUe',
        buttons: 'buttons-mrMP8kUe',
        button: 'button-mrMP8kUe',
        disabled: 'disabled-mrMP8kUe',
      };
    },
    19108: (e) => {
      e.exports = {
        wrap: 'wrap-__HYDlI5',
        dialog: 'dialog-__HYDlI5',
        offset: 'offset-__HYDlI5',
        title: 'title-__HYDlI5',
        main: 'main-__HYDlI5',
        disabled: 'disabled-__HYDlI5',
        icon: 'icon-__HYDlI5',
        pathIcon: 'pathIcon-__HYDlI5',
        syncIconWrap: 'syncIconWrap-__HYDlI5',
        syncIcon: 'syncIcon-__HYDlI5',
        rightButtons: 'rightButtons-__HYDlI5',
        hover: 'hover-__HYDlI5',
        expandHandle: 'expandHandle-__HYDlI5',
        button: 'button-__HYDlI5',
        selected: 'selected-__HYDlI5',
        childOfSelected: 'childOfSelected-__HYDlI5',
        renameInput: 'renameInput-__HYDlI5',
        warn: 'warn-__HYDlI5',
        visible: 'visible-__HYDlI5',
      };
    },
    14822: (e) => {
      e.exports = {
        wrap: 'wrap-sLDhMHB0',
        space: 'space-sLDhMHB0',
        tree: 'tree-sLDhMHB0',
      };
    },
    34393: (e) => {
      e.exports = { button: 'button-W4RYPlVi', disabled: 'disabled-W4RYPlVi' };
    },
    27011: (e, t, n) => {
      'use strict';
      function o(e, t) {
    ...
    67029: (e, t, n) => {
      ...
      function v(e, t) {
        ...
        return o.createElement(
          ...
          C,
          w,
          o.createElement('span', { className: m(e, E) }),
        );
      }
    ...
    23263: (e, t, n) => {
      ...
      function S(e) {
        const { reference: t, children: n, iconOnly: r, endIcon: s, ...l } = e,
          a = (function (e, t) {
            const {
              className: n,
              color: o = 'brand',
        ...
        return o.createElement(
          'button',
          { ...y(l), className: a, ref: t },
          !(0, v.isIconOnly)(n, r) &&
            o.createElement('span', { className: _().content }, n),
          s && o.createElement(i.Icon, { className: _().icon, icon: s }),
        );
      }
      n(71687);
      function C(e, t) {
        const { align: n = 'start', size: o = 'xsmall' } = t;
        return p(e['round-tabs'], e[`align-${n}`], e[`size-${o}`]);
      }
      function w(e, t) {
        const { variant: n = 'primary', isChecked: o } = t;
        return p(e.tab, e[`tab-${n}`], o && e.checked);
      }
      var T = n(79727),
        M = n.n(T);
      const I = o.forwardRef((e, t) => {
        ...
        return o.createElement(
          'div',
          { className: C(s, e), ref: t },
          n.map((e) => {
            const { isChecked: t, ...n } = e;
            return o.createElement(S, {
              ...n,
              className: w(s, { ...n, variant: i, isChecked: t }),
              size: r,
              variant: i,
            });
          }),
      ...
      var E = n(29540),
        k = n(11069);
      const D = (0, u.getLogger)('Chart.ManageDrawings'),
        L = new Map();
      function x(e) {
        let t = L.get(e);
        return void 0 === t && ((t = new (c())([])), L.set(e, t)), t;
      }
      const j = new l.TranslatedString(
          ...
          if (t && l) {
            ...
            if (o) {
              const n = Array.from(o)
                ...
                .filter(g.notNull);
              n.length > 0 && t.removeSources(n, !1, j.format({ symbol: e }));
              const r = x(t.model().id());
      ...
      function R(e) {
        ...
        return (
          ...
          o.createElement(
            ...
            0 === b.length
              ? null === u
                ? o.createElement(m.Spinner, { className: k.spinner })
                : o.createElement(
                    'div',
                    { className: k.empty },
                    o.createElement(i.Icon, { className: k.image, icon: E }),
                    o.createElement('span', null, A),
                  )
              : b.map(
                  ({ symbol: e, drawingsCount: n, onRemove: r, onClick: i }) =>
                    o.createElement(h.DialogContentItem, {
                      key: e,
                      title: e,
                      subtitle: N(n),
                      removeBtnLabel: z,
    ...
    90006: (e, t, n) => {
      'use strict';
      n.r(t), n.d(t, { ObjectTreeDialogRenderer: () => Qo });
      var o = n(50959),
        r = n(962);
      ...
      var j = n(97482),
        ...
        R = n(51768);
      function B(e) {
        const { viewModel: t } = (0, T.ensureNotNull)((0, o.useContext)(x)),
          r = (0, L.useForceUpdate)(),
          i = t.selection();
        (0, o.useEffect)(() => {
          const e = {};
          return (
            t.onChange().subscribe(e, () => r()),
            () => {
        ...
        const s = !t.canSelectionBeUnmerged(),
          l = t.isSelectionCopiable(),
          a = t.isSelectionCloneable(),
          c = !l && !a,
          u = t.canSelectionBeGrouped(),
          d = !1;
        return o.createElement(
          o.Fragment,
          null,
          o.createElement(
            'div',
            { className: M(O.title, O.withoutIcon) },
          ...
          o.createElement(
            'div',
            { className: O.buttons },
            o.createElement(j.ToolWidgetIconButton, {
              className: M(O.button, !u && O.disabled),
              icon: A,
              onClick: function () {
                t.createGroupFromSelection();
              },
              isDisabled: !u,
              title: v.t(null, void 0, n(91073)),
              'data-name': 'group-button',
            }),
            o.createElement(
              D.ToolWidgetMenu,
              {
                className: M(O.button, c && O.disabled),
                isDisabled: c,
                content: o.createElement(E.Icon, { icon: N }),
                title: v.t(null, void 0, n(98129)),
                arrow: !1,
                isShowTooltip: !0,
            ...
            o.createElement(
              D.ToolWidgetMenu,
              {
                className: M(O.button, s && O.disabled),
                isDisabled: s,
                content: o.createElement(E.Icon, { icon: z }),
                title: v.t(null, void 0, n(45828)),
                arrow: !1,
                isShowTooltip: !0,
      ...
      var P = n(54773),
        ...
        F = n(7809),
        V = n(23642);
      const Y = ((U = 'OBJECT_TREE'), (e) => U + '__' + e);
      var U;
      const W = Y('SET_NODES'),
        K = Y('SYNC_NODES'),
        Z = Y('UPDATE_NODE'),
        q = Y('UPDATE_NODES'),
        $ = Y('RESET_TREE'),
        X = Y('SET_SELECTED_IDS'),
        J = Y('DROP_SELECTION'),
        Q = Y('SELECT_PREVIOUS'),
        ee = Y('SELECT_NEXT'),
        te = Y('MULTI_SELECT_PREVIOUS'),
        ne = Y('MULTI_SELECT_NEXT'),
        oe = Y('PROCESS_DROP_TARGET'),
        re = Y('UPDATE_DROP_TARGET'),
        ie = Y('HIDE_DROP_TARGET'),
        se = Y('START_MULTI_SELECT'),
        le = Y('STOP_MULTI_SELECT'),
        ae = (Y('REMOVE_NODE'), Y('SET_FOCUSED_NODE')),
        ce = Y('SCROLL_TO_ID'),
        ue = Y('SET_IS_SELECTED'),
        de = Y('SET_IS_EXPANDED'),
        he = Y('SET_DISABLED_NODES'),
        ge = Y('MOVE_NODES'),
        me = (Y('START_DRAG'), Y('END_DRAG')),
        pe = () => ({ type: Q }),
        fe = () => ({ type: ee }),
        ve = () => ({ type: te }),
        be = () => ({ type: ne }),
        ...
        ye = () => ({ type: J }),
        Se = (e) => ({ type: X, ids: e }),
        Ce = (e, t, n) => ({ type: ge, ids: e, targetId: t, dropType: n }),
        we = () => ({ type: se }),
        Te = () => ({ type: le }),
        Me = (e) => ({ type: ae, nodeId: e }),
        Ie = (e) => ({ type: ce, nodeId: e }),
        Ee = (e, t, n = 0) => ({ type: ue, nodeId: e, isSelected: t, mode: n }),
        ke = (e, t) => ({ type: de, nodeId: e, isExpanded: t }),
        De = (e) => ({ type: he, ids: e }),
        Le = () => ({ type: me });
      var xe = n(77145);
      const je = (e) => e.nodes,
        ...
        Oe = (e) => e.scrollToId,
        Re = (e, t) => t,
        Be = (0, xe.createSelector)([je, Re], (e, t) => e[t]),
        Pe = (0, xe.createSelector)([Ne, Re], (e, t) => e.ids.includes(t)),
        He = (0, xe.createSelector)([Ae, Re], (e, t) => e.includes(t)),
        Ge = (0, xe.createSelector)(
          [(e) => e.disabled, Ne, Re],
          (e, t, n) => !t.ids.includes(n) && e.includes(n),
        ),
        Fe = (0, xe.createSelector)(je, (e) => Object.keys(e)),
        Ve = (0, xe.createSelector)(Ne, ({ ids: e }) => e),
        Ye = (0, xe.createSelector)(Ne, ({ lastFocusedNodeId: e }) => e),
        Ue = (0, xe.createSelector)(Ne, ({ isMultiSelecting: e }) => e),
        We = (0, xe.createSelector)([je, Ve], (e, t) => t.map((t) => e[t])),
        Ke = (0, xe.createSelector)(je, (e) =>
          Object.values(e).filter((e) => 0 === e.level),
        ),
        Ze = (0, xe.createSelector)([je, Ke], (e, t) =>
          t.reduce((t, n) => [...t, ...qe(e, (0, T.ensureDefined)(n))], []),
        );
      function qe(e, t) {
        const n = [];
        for (const o of t.children) n.push(e[o]), n.push(...qe(e, e[o]));
        return n;
      }
      const $e = (0, xe.createSelector)([je, Ke, Ae], (e, t, n) => {
          const o = new Set(n);
          return t.reduce(
            (t, n) => [...t, ...Je(e, (0, T.ensureDefined)(n), o)],
            [],
          );
        }),
        Xe = (0, xe.createSelector)([je, Ve, Ae], (e, t, n) => {
          const o = new Set(n);
      ...
      function Je(e, t, n) {
        ...
        for (const r of t.children) {
          const t = e[r];
          void 0 !== t && (o.push(t), n.has(r) && o.push(...Je(e, t, n)));
        }
        return o;
      }
      function* Qe(e) {
        ...
        yield (0, S.put)(((e) => ({ type: W, nodes: e }))(o)),
          yield (0, S.put)(Se(t));
        !Ye(yield (0, S.select)()) &&
          t.length > 0 &&
          (yield (0, S.put)(Me(t[0])), yield (0, S.put)(Ie(t[0])));
      }
      function* et(e) {
        for (;;) {
          if ((yield (0, S.take)([se, le])).type === se) {
            const t = Fe(yield (0, S.select)()).filter((t) => !e(t));
            yield (0, S.put)(De(t));
          } else yield (0, S.put)(De([]));
        }
      }
      function* tt() {
        for (;;) {
          const { type: e } = yield (0, S.take)([ne, te]),
            t = yield (0, S.select)(),
            n = Ze(t),
            o = n.length,
            r = Ye(t),
          ...
          const a = at(t, e === ne ? 'next' : 'previous', n, l),
            { id: c } = a;
          i.includes(c) && r
            ? (yield (0, S.put)(Ee(r, !1, 1)), yield (0, S.put)(Me(c)))
            : yield (0, S.put)(Ee(c, !0, 1)),
            yield (0, S.put)(Ie(c));
        }
      }
      function* nt(e, t) {
        for (;;) {
          const { type: n } = yield (0, S.take)([ee, Q]),
            o = yield (0, S.select)(),
            r = Ze(o),
            i = We(o),
            s = Ye(o);
      ...
      function* ot(e, t = () => !0) {
        for (;;) {
          const { mode: n, nodeId: o, isSelected: r } = yield (0, S.take)(ue);
          let i = [...Ve(yield (0, S.select)())];
          const s = Ze(yield (0, S.select)());
          if (1 === n) r ? i.push(o) : i.splice(i.indexOf(o), 1);
          else if (2 === n && i.length > 0) {
            const e = Ye(yield (0, S.select)());
      ...
      function* rt(e = () => !0, t) {
        const {
          ...
          l = ze(yield (0, S.select)()),
          a = Be(yield (0, S.select)(), (0, T.ensureDefined)(n.parentId)),
          c = s && 'after' === o,
          u = We(yield (0, S.select)()),
          d = !c || (!r && e(u, n, o)) ? n : a,
          h = (l.node && l.node.id !== d.id) || l.dropType !== o;
        u.map((e) => e.id).includes(d.id)
          ? yield (0, S.put)({ type: ie })
          : h &&
            e(u, d, o) &&
            (yield (0, S.put)(
      ...
      function* it(e) {
        yield (0, S.throttle)(0, oe, rt, e);
      }
      function* st(e) {
        for (;;) {
          yield (0, S.take)(J);
          const t = We(yield (0, S.select)()),
            { node: n, dropType: o } = ze(yield (0, S.select)());
          if (n && o) {
            const r = new CustomEvent('tree-node-drop', {
              detail: { nodes: t, target: n.id, type: o },
            });
            if ((e && e(r), !r.defaultPrevented)) {
              const e = Ve(yield (0, S.select)());
              yield (0, S.put)(Ce(e, n.id, o));
            }
          }
        }
      }
      ...
      function* ct(e = {}) {
        ...
        for (
          t && c.push((0, S.fork)(t)),
            r && c.push((0, S.fork)(lt, r)),
            a && c.push((0, S.fork)(et, a));
          ;

        ) {
          l && (yield (0, S.call)(Qe, l));
            ...
            case K: {
              ...
              for (const e of n) {
                ...
                if (r.hasOwnProperty(t)) {
                  !(0, dt.deepEquals)(r[t].children, e.children)[0] &&
      ...
      var _t = n(42357),
        ...
        St = n(47201),
        Ct = n(70412);
      const wt = o.createContext({ size: 0, smallSizeTreeNodeAction: 1 }),
        Tt = { [w.Modifiers.Mod]: 1, [w.Modifiers.Shift]: 2 };
      var Mt = n(69533),
        It = n(3950);
      const Et = () => {};
          ...
          super(...arguments),
            ...
            (this._handleRef = (e) => {
              ...
              (0, T.ensureDefined)(n)(this._ref),
                ...
                (0, T.ensureDefined)(o)((0, yt.getEmptyImage)(), {
      ...
      const Dt = (e) => {
          const {
            ...
            { size: v, smallSizeTreeNodeAction: b } = (0, o.useContext)(wt),
            _ = (0, o.useRef)(null),
            y = (0, St.createSafeMulticastEventHandler)(
              (e) => (_.current = e),
              h,
            );
          let [S, C] = (0, Ct.useHover)();
          return (
            (bt.CheckMobile.any() || bt.CheckMobile.isIPad()) &&
              ((S = n), (C = { onMouseOut: Et, onMouseOver: Et })),
            o.createElement(
              'div',
              {
                className: M(
                ...
                onClick:
                  1 === v && 0 === b
                    ...
                    : function (e) {
                        ...
                        const o = Tt[(0, w.modifiersFromEvent)(e)] || 0;
                        !l && s && s(t, !n, o);
                        c && 0 === o && c(e, t);
                      },
                onContextMenu: T,
              ...
              i &&
                o.createElement(E.Icon, {
                  icon: Mt,
                  className: M(It.expandHandle, a && It.expanded),
                  onClick: function (e) {
      ...
      function xt(e, t) {
        ...
        let i = !1,
          s = o.parentId;
        for (; s && !i; ) (i = Pe(e, s)), (s = Be(e, s).parentId);
        return {
          ...o,
          isSelected: r,
          isChildOfSelected: i,
      ...
      function jt(e) {
        return (0, ut.bindActionCreators)(
          {
            setIsExpanded: ke,
            processDropTarget: _e,
            dropSelection: ye,
            selectNext: fe,
            selectPrevious: pe,
            setIsSelected: Ee,
      ...
      const Nt = (0, H.connect)(xt, jt, null, { context: Lt })(function (e) {
        ...
        zt = (0, H.connect)(xt, jt, null, { context: Lt })(Dt);
      var At = n(35749),
        Ot = n(85783),
        Rt = n(65718);
      function Bt(e) {
      ...
      function Vt(e) {
        return o.createElement(Ft, { ...e, ...(0, Ot.useDragLayer)(Gt) });
      }
      var Yt = n(3085),
        Ut = n(33127);
      ...
      function Kt(e) {
        ...
        return o.createElement(Wt, { ...e, connectDropTarget: n, ref: t });
      }
      const Zt = o.createContext({ isOver: !1, transform: void 0 });
      var qt = n(20577);
      function $t(e) {
      ...
      const Jt = (0, H.connect)(
        function (e) {
          const { boundBox: t, dropType: n, node: o } = ze(e);
      ...
      function Qt(e) {
        const { isDragging: t } = (0, Ot.useDragLayer)(Xt);
        return o.createElement(Jt, { ...e, isDragging: t });
      }
      const en = o.forwardRef((e, t) => {
        const n = (0, o.useContext)(Zt);
        return o.createElement(
          'div',
          { ...e, ref: t },
          e.children,
          n.isOver && o.createElement(Qt, { transform: n.transform }),
        );
      });
      var tn = n(80142),
        nn = n(43380);
      const on = 38 + w.Modifiers.Shift,
        rn = 40 + w.Modifiers.Shift;
      const sn = o.forwardRef(function (e, t) {
        const {
            navigationKeys: n,
            renderList: r,
            stopMultiSelect: i,
        ...
        (0, o.useEffect)(() => {
          var e;
          j && (null === (e = z.current) || void 0 === e || e.focus());
        }, []),
          (0, o.useEffect)(() => {
            const e = (e) => {
        ...
        const A = (0, o.useCallback)(() => (0, T.ensureNotNull)(Z.current), []),
        ...
        const P = (0, o.useCallback)((e) => {
            ...
            const { index: n } = e;
            return (
              n === B.current.length - 1 &&
                ((t = { ...t, bottom: 0, minHeight: t.height }),
                delete t.height),
              o.createElement('div', { style: t }, B.current[n].node)
            );
          }, []),
          H = (0, o.useCallback)(
            (e) => {
          ...
          G = (0, o.useCallback)(
            (e) => (0, T.ensure)(B.current[e].node.key),
            [],
          ),
          F = (0, o.useMemo)(
            () =>
              null === f
                ? { index: -1 }
                : { index: B.current.findIndex((e) => e.node.key === f.id) },
            [f],
          );
        d(z);
        const [V, Y, U, W] = (0, Ut.useOverlayScroll)(),
          K = (0, o.useRef)(null);
        (0, o.useEffect)(
          () => (0, T.ensureNotNull)(K.current).resetAfterIndex(0, !0),
          [R],
        ),
          (0, o.useEffect)(
            () => (0, T.ensureNotNull)(K.current).scrollToItem(F.index),
            [F],
          );
        const Z = (0, o.useRef)(null),
          ...
          X = (0, o.useRef)({
            startScroll(e) {
              const t = () => {
                null !== U.current &&
                  (($.current = requestAnimationFrame(t)),
            ...
            stopScroll() {
              null !== $.current &&
                (cancelAnimationFrame($.current), ($.current = null));
            },
            getListElement: () => U.current,
          });
        return (
          (0, o.useImperativeHandle)(t, () => X.current, []),
          (0, o.useEffect)(() => () => X.current.stopScroll(), [D]),
          o.createElement(
            Zt.Provider,
            { value: q },
            o.createElement(
              'div',
              {
                ...
                onKeyDown: function (e) {
                  ...
                  if (
                    e.defaultPrevented ||
                    (0, At.isNativeUIInteraction)(t, e.target)
                  )
                    return;
                  N || t !== on || (e.preventDefault(), b());
                  N || t !== rn || (e.preventDefault(), _());
              ...
              o.createElement(Yt.OverlayScrollContainer, {
                ...V,
                className: nn.overlayScrollWrap,
              }),
              o.createElement(vt.VariableSizeList, {
                ref: function (e) {
                  K.current = e;
                },
                className: nn.listContainer,
                width: E,
                height: k,
                itemCount: R.length,
                itemSize: H,
                ...
                overscanCount: 20,
                direction: (0, tn.isRtl)() ? 'rtl' : 'ltr',
              }),
              o.createElement(Vt, { dragPreviewRenderer: c, nodeRenderer: a }),
            ),
          )
        );
      });
      const ln = (0, H.connect)(
          function (e) {
            return {
              renderList: $e(e),
              orderedNodes: Ze(e),
              isMultiSelecting: Ue(e),
              selectedIds: Ve(e),
              scrollToId: Oe(e),
            };
          },
          ...
          const t = (0, o.useRef)(null),
            [{ isOver: n }, r] = (0, ft.useDrop)({
              accept: 'node',
              drop: (n, o) => {
                var r;
                ('touch' === e.drag || bt.isFF) &&
      ...
      function cn(e) {
        ...
        return (
          (0, o.useEffect)(() => {
            ...
            v(
              (function (e) {
                const t = (0, ut.applyMiddleware)(e);
                return (0, ut.createStore)(pt, t);
              })(e),
            );
            const o = e.run(ct, {
              initState: n,
          ...
          (0, o.useEffect)(
            () => (
              null !== f &&
                ...
                f.dispatch(((e) => ({ type: K, nodes: e }))(a))),
              () => {}
            ),
            [f, a],
          ),
          (0, o.useEffect)(() => {
            null !== f && c && f.dispatch(Se(c));
          }, [f, c]),
          (0, o.useEffect)(() => {
          ...
          null === f
            ? null
            : o.createElement(un, { store: f, scrollToId: m, ...p })
        );
      }
      const un = o.memo(function (e) {
        const { store: t, scrollToId: n, ...r } = e,
          i = 'touch' === e.drag ? F.TouchBackend : G.HTML5Backend;
        return (
          (0, o.useEffect)(() => {
            var e;
            t.dispatch(
          ...
          o.createElement(
            V.DndProvider,
            { backend: i, options: an },
            o.createElement(
              H.Provider,
              { store: t, context: Lt },
              o.createElement(ln, { ...r }),
            ),
          )
        );
      });
      function dn(e, t) {
        (0, R.trackEvent)('Object Tree', e, t);
      }
      function hn(e) {
        return e.length > 1 ? 'Multi select' : e[0].gaLabel();
      }
      function gn(e) {
        return (0, P.eventChannel)((t) => {
          const n = {};
          return (
            e.onChange().subscribe(n, () => t({ type: $ })),
            e.onGroupCreated().subscribe(n, (e) => t(ke(e, !0))),
            e
              .selection()
              .onChange()
              .subscribe(n, (e) => t(Se(e))),
            () => {
      ...
      function* mn() {
        for (;;) yield (0, S.take)([ee, Q]), dn('Select', 'Arrow');
      }
      function* pn() {
        for (;;) {
          const { mode: e } = yield (0, S.take)(ue);
          1 === e && dn('Multi select', 'Ctrl'),
            2 === e && dn('Multi select', 'Shift');
        }
      }
      function* fn(e) {
        for (;;) {
          yield (0, S.take)(J);
          const { node: t, dropType: n } = ze(yield (0, S.select)());
          if (t) {
            const o = We(yield (0, S.select)()),
      ...
      function* vn(e) {
        yield (0, S.fork)(mn), yield (0, S.fork)(pn), yield (0, S.fork)(fn, e);
      }
      function* bn(e) {
        yield (0, S.fork)(vn, e);
        const t = yield (0, S.call)(gn, e);
      ...
      const _n = o.createContext(null);
      var yn = n(33933),
        Sn = n(898),
        Cn = n(14822);
      const wn = C.mobiletouch ? 'touch' : 'native';
      function Tn(e) {
        const {
            viewModel: t,
            showHeader: n = !0,
          ...
          [a, c] = (0, Sn.useDimensions)(),
          [u, d] = (0, o.useState)(null),
          h = (0, o.useMemo)(() => ({ isTouch: C.touch, isDialog: i }), [i]);
        return o.createElement(
          _n.Provider,
          { value: h },
          o.createElement(
            ...
            o.createElement(
              ...
              {
                className: Cn.wrap,
                onContextMenu: yn.preventDefaultForContextMenu,
              },
              n && o.createElement(B, null),
              o.createElement(
                'div',
                {
                  className: Cn.space,
      ...
      function Ln(e) {
        ...
        return o.createElement(E.Icon, {
          className: I()(Dn.button, n && Dn.disabled, t),
          ...r,
        });
      }
      var xn = n(77975);
      const jn = v.t(null, void 0, n(91073)),
        Nn = v.t(null, void 0, n(35038)),
        zn = v.t(null, void 0, n(15101)),
        An = v.t(null, void 0, n(42284)),
        On = v.t(null, void 0, n(31971)),
        Rn = v.t(null, void 0, n(81428)),
        Bn = v.t(null, void 0, n(34596));
      var Pn = n(35936),
        Hn = n(33765),
        Gn = n(52870),
        Fn = n(49756),
      ...
      function Wn(e) {
        const { id: t } = e,
          ...
          i = r.entity(t);
        return null === i ? null : o.createElement(Kn, { ...e, entity: i });
      }
      function Kn(e) {
        const {
            id: t,
          ...
          m = (0, o.useContext)(_n),
          { size: p } = (0, o.useContext)(wt),
          [f, b] = (0, o.useState)(!1),
          _ = (0, o.useRef)(null),
          [y, S] = (0, o.useState)(u.title()),
          [C, I] = (0, o.useState)(u.getIcon()),
          [k, D] = (0, o.useState)(u.isLocked()),
          [L, j] = (0, o.useState)(u.isVisible()),
          [N, z] = (0, o.useState)(u.isActualInterval()),
          [A, O] = (0, o.useState)(u.getDrawingSyncState()),
          [R, B] = (0, o.useState)(!1),
          [P, H] =
            ((0, xn.useWatchedValueReadonly)({
        ...
        (0, o.useEffect)(() => {
          ...
          u.onLockChanged().subscribe(e, () => D(u.isLocked())),
            u.onVisibilityChanged().subscribe(e, () => j(u.isVisible()));
          const t = u.onTitleChanged();
          t && t.subscribe(e, () => S(u.title())),
            u
              .onIsActualIntervalChange()
              .subscribe(e, () => z(u.isActualInterval())),
            u
              .onSyncStateChanged()
          ...
          (0, o.useEffect)(() => {
            const e = {};
            return (
              g.hoveredObjectChanged().subscribe(e, Q),
              () => {
        ...
        if (c) {
          ...
          e && (F['data-parent-name'] = e.title()),
            (F['data-type'] = u.hasChildren() ? 'group' : 'data-source');
        }
        const V = En.enabled('test_show_object_tree_debug')
          ...
          o.createElement(
            'span',
            {
              className: M(
                ...
                s && Un.selected,
                r && Un.offset,
                l && Un.childOfSelected,
                R && !i && !s && !l && Un.hover,
                K && !i && !s && !l && Un.dialog,
              ),
              onMouseDown: function (e) {
                f &&
                  !(0, T.ensureNotNull)(_.current).contains(e.target) &&
                  H(!0);
              },
              onClick:
                1 === p
                  ...
                  : function (e) {
                      if (e.defaultPrevented) return;
                      if (0 !== (0, w.modifiersFromEvent)(e)) return;
                      if (G.current)
                        e.preventDefault(),
                  ...
                  o.createElement(Ln, {
                    ...
                    onClick: N
                      ...
                      : function (e) {
                          if (e.defaultPrevented) return;
                          e.preventDefault(),
                            g.openProperties(u, Pn.TabNames.visibility);
                        },
                    title: (function () {
                      if (!N) return q;
                      return L ? On : Rn;
            ...
            U &&
              o.createElement(kn.InputControl, {
                value: y,
                onChange: function (e) {
                  S(e.currentTarget.value);
                },
                onClick: yn.preventDefault,
                className: Un.renameInput,
                onKeyDown: function (e) {
                  27 === (0, w.hashFromEvent)(e)
                    ? (e.preventDefault(), S(u.title()), b(!1))
                    : 13 === (0, w.hashFromEvent)(e) &&
                      (e.preventDefault(), J());
                },
        ...
        constructor(e) {
          super(e),
            ...
            (this._matchMedia = window.matchMedia(
              _.DialogBreakpoints.TabletSmall,
            )),
            (this.state = {
              showDrawer: !1,
              showDialog: !1,
            ...
            o.createElement(
              ...
              this.state.showDrawer &&
                o.createElement(
                  ...
                  o.createElement(y.ManageDrawings, {
      ...
      class ro {
        constructor(e) {
          (this._onChange = new (eo())()),
            (this._recalculate = () => {
              const e = this._groupModel
                  .groups()
                  .map((e) => no(e.id, e.instanceId())),
            ...
            (this._model = e),
            (this._selectionApi = new to.SelectionApi(this._model)),
        ...
        set(e) {
          ...
          this._selectionApi.set(t.map((e) => oo(e).persistentId)),
            (this._selected = n),
            this._onChange.fire(this._selected);
        }
      ...
      var lo = n(47539),
        ...
        vo = n(57674),
        bo = n(46627);
      const _o = new lo.TranslatedString(
          'show {title}',
          v.t(null, void 0, n(87358)),
        ),
        yo = new lo.TranslatedString(
          'hide {title}',
          v.t(null, void 0, n(70301)),
        ),
        So = new lo.TranslatedString(
          'lock {title}',
          v.t(null, void 0, n(50193)),
        ),
        Co = new lo.TranslatedString(
          'unlock {title}',
          v.t(null, void 0, n(92421)),
        ),
        wo = new lo.TranslatedString(
          'change {sourceTitle} title to {newSourceTitle}',
          v.t(null, void 0, n(40001)),
        ),
        To = new lo.TranslatedString(
      ...
      function Io(e) {
        return e instanceof uo.DataSource && e.showInObjectTree()
          ? no(e.id(), e.instanceId())
          : null;
      }
      function Eo(e) {
        return new lo.TranslatedString(e.name(), e.title());
      }
      const ko = new (eo())(),
        Do = 'do_not_invalidate_chart_on_changing_line_tools';
      class Lo {
        constructor(e, t) {
          (this._syncStateChanged = new (eo())()),
            (this._lineToolsAffectChartInvalidation =
              new bo.FeatureToggleWatchedValue(Do, !1)),
            ...
            (this._undoModel = e),
            (this._dataSource = t),
            (0, ao.isLineTool)(this._dataSource) &&
          ...
          null !== n &&
            n === t &&
            n.isSynchronizable() &&
            mo.isToolCreatingNow.subscribe(this._updateSyncState);
        }
        destroy() {
          (0, ao.isLineTool)(this._dataSource) &&
            (this._dataSource.linkKey().unsubscribe(this._updateSyncState),
            this._dataSource.sharingMode().unsubscribe(this._updateSyncState)),
            mo.isToolCreatingNow.unsubscribe(this._updateSyncState);
        }
        id() {
          return no(this._dataSource.id(), this._dataSource.instanceId());
        }
        title() {
          const e = this._dataSource;
          return (0, ao.isLineTool)(e)
            ? e.properties().title.value() || e.translatedType()
            : (0, ho.isSeries)(e) && this._undoModel.mainSeries() === e
            ? e.symbolTitle(
                void 0,
                void 0,
                (0, bt.onWidget)() ? 'exchange' : 'listed_exchange',
              )
            : e.title();
        }
        gaLabel() {
        ...
        canBeRenamed() {
          return (0, ao.isLineTool)(this._dataSource);
        }
        fullyConstructed() {
        ...
        getIcon() {
          ...
          let o = { type: In.Svg, content: n ? po : fo };
          if (e && t)
            if ('loadSvg' === t.type) {
              const [n, r] = t.svgId.split('.'),
                i = 'linetool' === n ? e.linetool[r] : e.series[Number(r)];
              o = { type: In.Svg, content: i || fo };
            } else
              'svgContent' === t.type &&
                (o = { type: In.Svg, content: t.content });
          return o;
        }
        onIconChanged() {
        ...
        setVisible(e) {
          const t = (e ? _o : yo).format({ title: Eo(this._dataSource) });
        ...
        setLocked(e) {
          if ((0, ao.isLineTool)(this._dataSource)) {
        ...
        _insertSources(e, t) {
          ...
          this._undoModel.beginUndoMacro(To);
          const r = () => {
      ...
      class xo {
        constructor(e, t) {
          (this._onTitleChanged = new (eo())()),
            (this._onVisibilityChanged = new (eo())()),
            (this._onLockChanged = new (eo())()),
            (this._onIsActualIntervalChanged = new (eo())()),
            (this._syncStateChanged = new (eo())()),
        ...
        id() {
          return no(this._group.id, this._group.instanceId());
        }
        title() {
        ...
        childrenIds() {
          ...
          return (
            ...
            new Set(e.map((e) => no(e.id(), e.instanceId())))
          );
        }
        hasChildren() {
          return !0;
      ...
      class jo {
        constructor(e) {
          (this._hoveredObjectChanged = new (eo())()),
        ...
        canBeGroupped(e) {
          ...
          if (
            ...
            t.some((e) => !(0, ao.isLineTool)(e) || !e.boundToSymbol()))
          )
            return !1;
          const n = this._undoModel.model(),
        ...
        contextMenuActions(e, t, n) {
          const o = new go.ActionsProvider(e, n),
            r = [];
          return (
        ...
        hoveredObjectId() {
          return Io(this._undoModel.model().hoveredSource());
        }
        hoveredObjectChanged() {
          return this._hoveredObjectChanged;
        }
        _onModelHoveredSourceChanged(e) {
          this._hoveredObjectChanged.fire(Io(e));
        }
        _createObjectById(e) {
          const t = oo(e).persistentId,
      ...
      var No = n(88029),
        ...
        Fo = n(33055),
        Vo = n(35149);
      const Yo = (0, l.getLogger)('Platform.GUI.ObjectTree');
      const Uo = new lo.TranslatedString(
          'move objects',
        ...
        Ko = new lo.TranslatedString(
          'unlock objects',
          v.t(null, void 0, n(66824)),
        ),
        Zo = new lo.TranslatedString(
          'show objects',
          v.t(null, void 0, n(63549)),
        ),
        qo = new lo.TranslatedString(
          'hide objects',
          v.t(null, void 0, n(28506)),
        ),
        $o = new lo.TranslatedString(
          'remove objects',
      ...
      class Xo {
        constructor(e) {
          (this._nodes = {}),
            ...
            (this._isContextMenuOpened = new (Ro())(!1)),
            ...
            (this._init = () => {
              ...
              e.hasModel() &&
                ...
                (this._selection = new ro(this._model)),
                this._update());
            }),
            (this._update = () => {
              null === this._timeout &&
        ...
        isMain(e) {
          return oo(e.id()).persistentId === this._controller.mainSeries().id();
        }
        selection() {
        ...
        openProperties(e, t) {
          const n = this._model.dataSourceForId(oo(e.id()).persistentId);
            ...
            : (this.selection().set([e]),
              null !== n
                ? this._controller.mainSeries() === n
                  ...
                  : ((0, ao.isLineTool)(n) || (0, co.isStudy)(n)) &&
        ...
        canSelectionBeUnmerged() {
          ...
          return (
            1 === e.length &&
            this.canNodeWithIdBeUnmerged(oo(e[0].id()).persistentId)
          );
        }
        ...
        copySelection() {
          const e = this._getSelectedEntities(),
            t = e.map((e) =>
              (0, T.ensureNotNull)(
                this._model.dataSourceForId(oo(e.id()).persistentId),
              ),
            );
          this._chart
            .value()
        ...
        cloneSelection() {
          ...
          t.every(ao.isLineTool) &&
            (this._controller.cloneLineTools([...t], !1), dn('Clone', hn(e)));
        }
        rename(e, t) {
        ...
        async openContextMenu(e, t, n) {
          ...
          if (i.length > 0) {
            ...
            const t = oo(e.id()).persistentId,
              r = this._model.dataSourceForId(t),
              s = r instanceof ho.Series,
            ...
            (a = s
              ...
              zo.ContextMenuManager.showMenu(
                i,
                n,
        ...
        _getRenameAction(e) {
          return new Ao.Action({
            ...
            icon: Fo,
            onExecute: () => {
              e(), dn('Context menu rename', hn(this._objects));
            },
          });
        }
        _getActionsForGroupItem(e, t, n) {
          ...
          1 === this._objects.length &&
            r.unshift(this._getRenameAction(t), new Ao.Separator()),
            n && r.unshift(this._getGroupAction(), new Ao.Separator());
          const i = (0, go.createSyncDrawingActions)(
            this._chart.value(),
            o.filter(ao.isLineTool),
          );
          i.length && (i.shift(), i.push(new Ao.Separator()), r.push(...i));
          const s = this._chart.value().actions().format.getState();
          return (
            r.push(
              new Ao.Action({
                actionId: 'ObjectsTree.ToggleItemLocked',
                label: e.isLocked() ? zn : An,
                icon: e.isLocked() ? Bo : Po,
                onExecute: () => this.setIsLocked(e.id(), !e.isLocked()),
              }),
              new Ao.Action({
                actionId: 'ObjectsTree.ToggleItemVisibility',
                label: e.isVisible() ? On : Rn,
                icon: e.isVisible() ? Ho : Go,
              ...
              new Ao.Action({
                ...
                hotkeyHash: w.isMacKeyboard ? 8 : 46,
              }),
              new Ao.Separator(),
              new Ao.Action({
                actionId: s.actionId,
        ...
        _unmergeSelection(e) {
          ...
          const n = t[0],
            o = (0, T.ensureNotNull)(
              this._model.dataSourceForId(oo(n.id()).persistentId),
            );
          if (!(0, No.isPriceDataSource)(o))
          ...
          dn(0 === e ? 'New pane above' : 'New pane below', hn([n]));
        }
        _recalculateTree() {
          const e = new io(this._controller, this._facade);
      ...
      var Jo = n(88279);
      class Qo extends Jo.DialogRenderer {
        constructor() {
          super(),
            (this._handleClose = () => {
          ...
          const e = (0, Xn.service)(Jn.CHART_WIDGET_COLLECTION_SERVICE);
          (this._activeChartWidget = e.activeChartWidget.value()),
            (this._viewModel = new Xo(e.activeChartWidget));
        }
        hide() {
          this._handleClose();
        }
    ...
    23481: (e) => {
      e.exports = {
        ...
        ms_MY: ['keluarkan semua alat-alat garisan untuk {symbol}'],
