(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8890],
  {
    ...
    60365: (e) => {
      e.exports = { label: 'label-veVJ4P41' };
    },
    6730: (e) => {
      e.exports = {
    ...
    70493: (e, t, n) => {
      ...
      function _(e) {
        ...
        return o.createElement(
          ...
          o.createElement('span', { className: a(_ && w.hiddenTitle) }, l),
          _ && o.createElement(h.Loader, { color: 'white' }),
        );
      }
      var y = n(7720),
        N = n(6730);
          ...
          (i) =>
            o.createElement(
              ...
              o.createElement(
                s.PopupDialog,
                {
                  className: a(N.popupDialog, h),
                  isOpened: M,
                  backdrop: C,
                  onClickBackdrop: k,
                  onClickOutside: w ? k : void 0,
                  onKeyDown: T,
                  autofocus: !0,
                  fixedBody: !0,
                },
                o.createElement(
                  'div',
                  { className: a(N.wrap, g), 'data-name': v },
                  o.createElement(
                    'div',
                    {
                      className: a(
                        N.main,
                        !S && N.marginWithoutCloseButton,
                        i && N.small,
                      ),
                    },
                    t &&
                      o.createElement(
                        'div',
                        { className: a(N.title, i && N.small) },
                        t,
                      ),
                    (function (t) {
                      if ('html' in e)
                        return o.createElement(f.TouchScrollContainer, {
                          className: a(N.content, t && N.small, N.html, p),
                          dangerouslySetInnerHTML: { __html: e.html },
                        });
                      if ('content' in e)
                        return o.createElement(
                          f.TouchScrollContainer,
                          { className: a(N.content, t && N.small, p) },
                          e.content,
                        );
                      return null;
                    })(i),
                    l &&
                      ...
                      o.createElement(
                        'div',
                        { className: a(N.footer, i && N.small) },
                        l.map((e, t) =>
                          o.createElement(_, {
                            ...e,
                            key: e.name,
      ...
      function L(e) {
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(M.Autocomplete, {
              maxLength: t,
              value: n,
              onChange: function (e) {
                a(e);
      ...
      var B = n(962);
      const x = new (n(51826).DialogsOpenerManager)();
      const D = function (e) {
          const {
              title: t,
              onClose: a = () => {},
        ...
        I = function (e) {
          const {
            ...
            p = (0, o.useRef)(null),
            [g, C] = (0, o.useState)(r || ''),
            [E, w] = (0, o.useState)(() => m(g)),
            _ = b(e);
          return o.createElement(S, {
            title: t || l.t(null, void 0, n(35038)),
            content: o.createElement(L, {
              ..._,
              nameInputRef: p,
              maxLength: a,
              placeholder: i,
        ...
        P = function (e, t, n) {
          ...
          if (x.isOpened(a))
            return (0, p.ensureDefined)(x.getDialogPayload(a)).closeHandler;
          ...
          return (
            ...
            x.setAsOpened(a, { closeHandler: i }),
            i
          );
        };
    },
