(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [9039],
  {
    ...
    37558: (e, t, n) => {
      'use strict';
      n.d(t, { DrawerManager: () => a, DrawerContext: () => l });
      var r = n(50959),
        o = n(99054);
    ...
    41590: (e, t, n) => {
      ...
      function d(e) {
        const {
          ...
          v = (0, o.ensureNotNull)((0, r.useContext)(u.DrawerContext)),
          [y] = (0, r.useState)(() => (0, l.randomHash)()),
          h = (0, r.useRef)(null),
          g = (0, r.useContext)(c.CloseDelegateContext);
        return (
          (0, r.useLayoutEffect)(
            () => (
              (0, o.ensureNotNull)(h.current).focus({ preventScroll: !0 }),
              g.subscribe(v, n),
              v.addDrawer(y),
              () => {
                v.removeDrawer(y), g.unsubscribe(v, n);
              }
            ),
            [],
          ),
          r.createElement(
            ...
            r.createElement(
              ...
              y === v.currentDrawer &&
                r.createElement('div', { className: f.backdrop, onClick: n }),
              r.createElement(
                i.TouchScrollContainer,
                {
                  className: a(f.drawer, m.drawer, f[`position${t}`], p),
                  tabIndex: -1,
                  ref: h,
    ...
    50628: (e, t, n) => {
      ...
      function i(e) {
        const {
          ...
          g = (0, r.useContext)(u.CloseDelegateContext),
          C = (0, c.useOutsideEvent)({
            handler: function (e) {
              p && p(e);
              if (!f) return;
              const t = (0, a.default)(d) ? d() : d;
        ...
        return (
          ...
          (0, r.useLayoutEffect)(() => {
            if (l.CheckMobile.iOS())
              return (
                null !== s.current &&
                  (0, o.disableBodyScroll)(s.current, { allowTouchMove: u(s) }),
                () => {
    ...
    95257: (e, t) => {
      ...
      (w.constructor = C), v(w, h.prototype), (w.isPureReactComponent = !0);
      var E = Array.isArray,
      ...
      function R(e, t, r) {
        ...
        if (null != t)
          ...
          t))
            b.call(t, o) && !S.hasOwnProperty(o) && (a[o] = t[o]);
        var u = arguments.length - 2;
        if (1 === u) a.children = r;
        else if (1 < u) {
          for (var c = Array(u), i = 0; i < u; i++) c[i] = arguments[i + 2];
          a.children = c;
        }
        if (e && e.defaultProps)
      ...
      function O(e, t, o, a, l) {
        ...
        if (((u = 0), (a = '' === a ? '.' : a + ':'), E(e)))
          ...
          for (e = i.call(e), c = 0; !(s = e.next()).done; )
            u += O((s = s.value), t, o, (i = a + N(s, c++)), l);
        else if ('object' === s)
          throw (
            ((t = String(e)),
            Error(
      ...
      (t.Children = {
        ...
        (t.cloneElement = function (e, t, r) {
          ...
          if (1 === c) o.children = r;
            ...
            u = Array(c);
            for (var i = 0; i < c; i++) u[i] = arguments[i + 2];
            o.children = u;
          }
          return {
            $$typeof: n,
    ...
    51150: (e) => {
      e.exports = {
        drawer: 'drawer-VW29iqAD',
        drawerItem: 'drawerItem-VW29iqAD',
        menuWrap: 'menuWrap-VW29iqAD',
        menuBox: 'menuBox-VW29iqAD',
        card: 'card-VW29iqAD',
        cardRow: 'cardRow-VW29iqAD',
        mini: 'mini-VW29iqAD',
        fadeTop: 'fadeTop-VW29iqAD',
        fadeBottom: 'fadeBottom-VW29iqAD',
      };
    },
    31726: (e) => {
      e.exports = {
    ...
    36647: (e, t, n) => {
      ...
      const y = (0, r.forwardRef)((e, t) => {
        const {
          ...
          i = (0, r.useCallback)(
            (e) => {
              27 === (0, p.hashFromEvent)(e) && o();
            },
            [o],
          ),
          f = (0, r.useCallback)(() => {
            (0, m.globalCloseMenu)(), o();
          }, [o]),
          y = (0, r.useCallback)(() => {
      ...
      function b(e) {
        ...
        return r.createElement(
          'div',
          { className: s()(E.groupRow, c), style: o },
          t &&
            r.createElement(
              'div',
          ...
          r.createElement(
            ...
            r.createElement(
              'span',
              { className: E.text, style: a, onClick: l },
              n,
            ),
            u &&
      ...
      function S(e) {
        ...
        return r.createElement(
          ...
          e.title &&
            r.createElement(
              'div',
              { className: s()(E.titleWrapper, e.cardRowClass) },
              e.tooltipIcon &&
                r.createElement(w.Icon, {
                  icon: e.tooltipIcon,
                  className: E.icon,
              ...
              r.createElement('span', { className: E.title }, e.title),
            ),
          'common' === a.type && r.createElement(R, { ...a }),
          'news' === a.type && r.createElement(_, { cardType: n, ...a }),
          o &&
            ('mob' !== n || !o.hideInMobileMode) &&
            r.createElement(
              'div',
              { className: s()(E.group, e.cardRowClass) },
              r.createElement(k, { ...o }),
            ),
        );
      }
        ...
        const { content: t = [], subTitle: n, cardRowClass: o } = e,
          a = t.map((e, t) => {
            ...
            return r.createElement(
              ...
              n && r.createElement('span', { className: E.groupTitle }, n),
              o.map((e, t) =>
                r.createElement(b, { key: `contentRow${t}`, ...e }),
              ),
            );
          }),
          l =
            'string' == typeof n
              ? n
              : n.map((e, t) =>
                  r.createElement(b, { key: `subTitle${t}`, ...e }),
                );
        return r.createElement(
          'div',
          { className: o },
          r.createElement('span', { className: E.subtitle }, l),
      ...
      var x = n(51150);
      const N = (0, g.mergeThemes)(C.DEFAULT_MENU_THEME, {
        menuWrap: x.menuWrap,
        menuBox: x.menuBox,
      });
      function O(e) {
        ...
        const O = { display: R ? 'block' : 'none', width: E },
          [D, T] = (0, r.useState)(!1);
        u(
          w,
          () => T(!1),
        ...
        const B = { display: D ? 'block' : 'none', width: E },
          M = m ? s()(x.card, x[m]) : x.card;
        return r.createElement(
          f.DrawerManager,
          null,
          r.createElement(
              ...
              e
                ? r.createElement(
                    ...
                    t.map((e, t) =>
                      r.createElement(
                        'div',
                        { key: `${t}`, className: x.drawerItem },
                        r.createElement(S, { cardType: 'mob', ...e }),
                      ),
                    ),
                  )
                : r.createElement(
      ...
      function T(e) {
        ...
        return (
          ...
          o.render(r.createElement(O, { ...t }), D),
          B
        );
      }
      function B() {
        null !== D && (o.unmountComponentAtNode(D), D.remove(), (D = null));
      }
      function M(e, t, n) {
        const r = e.target,
          ...
          u = (0, a.ensureNotNull)(r.closest('.chart-container')),
          c = u.getBoundingClientRect(),
          i = (0, a.ensureNotNull)(u.parentElement).getBoundingClientRect(),
          f = o.left + e.point.x + l,
          d = Math.round(f - t / 2),
          p = Math.min(d + t, c.right, i.right);
        let m,
          v,
          y = Math.max(p - t, c.left, i.left);
        y + t >= i.right && (y = i.right - t);
        const h = c.bottom - (o.top + e.point.y + s),
          g = c.height - h - e.marginTop;
        return (
          g < n
            ? ((v = e.marginTop + c.top), (m = Math.max(g, 0)))
            : (v = c.height + c.top - h - n),
          { x: y, y: v, overrideHeight: m }
        );
      }
    },
  },
