(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8180, 2215],
  {
      ...
      function v(t) {
        ...
        if (
          ('border-box' === r.boxSizing &&
            ...
            Math.round(a + u) !== n && (a -= d(r, 'top', 'bottom') + u)),
          !(function (t) {
          ...
          var c = Math.round(s + i) - e,
            f = Math.round(a + u) - n;
          1 !== Math.abs(c) && (s -= c), 1 !== Math.abs(f) && (a -= f);
        }
        return b(o.left, o.top, s, a);
      }
      var y =
    ...
    95257: (t, e) => {
      ...
      (w.constructor = m), v(w, _.prototype), (w.isPureReactComponent = !0);
      var g = Array.isArray,
      ...
      function R(t, e, r) {
        ...
        if (t && t.defaultProps)
          for (o in (a = t.defaultProps)) void 0 === i[o] && (i[o] = a[o]);
        return {
          $$typeof: n,
          type: t,
          key: u,
        ...
        (e.cloneElement = function (t, e, r) {
          ...
          if (null != e) {
            ...
            for (c in e)
              E.call(e, c) &&
                !S.hasOwnProperty(c) &&
                (o[c] = void 0 === e[c] && void 0 !== a ? a[c] : e[c]);
          }
