  ...
  [892],
  {
    ...
    65279: (e, t, r) => {
      ...
      r.d(t, {
        ...
        createPropertyDefinitionsGeneralGroup: () => _,
        ...
        getLockPriceScaleDefinitionProperty: () => U,
        getPriceScaleSelectionStrategyDefinitionProperty: () => F,
        getScaleRatioDefinitionProperty: () => q,
        getSymbolDefinitionProperty: () => Z,
        isPropertyDefinitionsGroup: () => $,
      ...
      function F(e, t) {
        const r = (0, Y.makeProxyDefinitionProperty)(t);
        return (r.setValue = (t) => e.setPriceScaleSelectionStrategy(t)), r;
      }
      function U(e, t, r, i) {
        const o = (0, Y.makeProxyDefinitionProperty)(t);
        return (
          (o.setValue = (t) => {
            const o = { lockScale: t };
      ...
      function q(e, t, r, i) {
        const o = (0, Y.makeProxyDefinitionProperty)(t, i);
        return (
          (o.setValue = (i) => {
      ...
      function X(e, t, r, i, o) {
        let n;
        if (null !== r) {
          const e = (0, K.combineProperty)(Q, t, r);
          n = (0, Y.makeProxyDefinitionPropertyDestroyable)(e);
        } else
          n = (0, Y.makeProxyDefinitionProperty)(t, [
            () => Q(t.value(), 0),
            (e) => e,
          ]);
        return (
      ...
      function Z(e, t, r, i, o, n) {
        ...
        var l, p;
        const u = (0, Y.convertToDefinitionProperty)(e, t, o, s);
        n && (u.setValue = n);
        const c = new Map();
        (u.subscribe = (e, r) => {
          const i = (e) => {
