(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2306],
  {
    ...
    20695: (t) => {
      t.exports = { button: 'button-_N8p4OlI' };
    },
    86405: (t) => {
      t.exports = {
        item: 'item-Rhs937dU',
    ...
    94720: (t, e, o) => {
      ...
      function c(t) {
        const {
          ...
          })((0, s.getGroupCellRemoveRoundBorders)(_));
        return n(
          p,
          l().button,
          l()[`size-${o}`],
    ...
    70114: (t, e, o) => {
      ...
      function m(t) {
        const {
          ...
          C = '' === y,
          T = String(W()).toLowerCase() === p.white,
          [S, x, P] = (0, d.useCustomColors)();
        return i.createElement(
          u.ToolWidgetMenu,
          {
            className: w,
            content: i.createElement(
              ...
              i.createElement(
                ...
                { className: g.colorBg },
                i.createElement('div', {
                  className: s()(g.color, C && g.multicolor, T && g.white),
          ...
          i.createElement(h.ColorPicker, {
            ...
            onAddColor: function (t) {
              x(t), (0, r.ensureNotNull)(b.current).close();
            },
    ...
    61259: (t, e, o) => {
      ...
      function y(t) {
        const {
          ...
          _ = (0, l.useProperty)((0, s.ensureDefined)(e)),
          y = 'mixed' === _ || !_,
          b = (function (t) {
    ...
    27797: (t, e, o) => {
      ...
      var u = o(6914),
        ...
        g = o(61561);
      function m(t) {
        const { index: e, color: s, selected: a, onSelect: m } = t,
          [v, w] = (0, i.useState)(!1),
          y = (0, i.useContext)(p),
          b = (0, i.useRef)(null),
          f = Boolean(y) && !c.CheckMobile.any();
        return i.createElement(
          i.Fragment,
          null,
          i.createElement('div', {
            ...
            className: n(
              ...
              a && g.selected,
              !s && g.empty,
              String(s).toLowerCase() === u.white && g.white,
            ),
            onClick: function () {
              m(s);
            },
            onContextMenu: f ? C : void 0,
          }),
          f &&
            i.createElement(
              d.PopupMenu,
      ...
      var P = o(66454);
      const W = '#000000',
        E = r.t(null, { context: 'Color Picker' }, o(40276));
      ...
      var B = o(80072);
      const k = r.t(null, { context: 'Color Picker' }, o(53585)),
        I = r.t(null, { context: 'Color Picker' }, o(81865));
        ...
        render() {
          ...
          return l
            ...
            : i.createElement(
                ...
                i.createElement('div', { className: B.separator }),
                i.createElement(
                  p.Provider,
                  { value: a },
                  i.createElement(
                    ...
                    o &&
                      i.createElement('div', {
                        className: s()(B.customButton, 'apply-common-tooltip'),
                ...
                n &&
                  i.createElement(
                    i.Fragment,
                    null,
                    i.createElement('div', { className: B.sectionTitle }, I),
    ...
    74749: (t) => {
      t.exports = { button: 'button-rqVQ8gUB' };
    },
    97482: (t, e, o) => {
      'use strict';
    ...
    2209: (t, e, o) => {
      'use strict';
      o.r(e), o.d(e, { FavoriteDrawingToolbar: () => m });
      var i = o(44352),
        n = o(20687),
        s = o(65383),
        r = (o(50151), o(32563)),
      ...
      class m extends n.FloatingToolbar {
        ...
        _onFavoriteAdded(t) {
          this.addWidget(this._createLinetoolWidget(t)),
            s.LinetoolsFavoritesStore.favorites().filter(v).length > 0 &&
              (this._canBeShownValue.setValue(!0), this.show());
        }
        _onFavoriteRemoved(t) {
          this.removeWidget(this._linetoolsWidgets[t]),
            delete this._linetoolsWidgets[t],
            0 === s.LinetoolsFavoritesStore.favorites().filter(v).length &&
        ...
        _loadVisibilityState() {
          const t = s.LinetoolsFavoritesStore.favorites().filter(v).length > 0;
          this._canBeShownValue.setValue(t);
          const e = s.LinetoolsFavoritesStore.favoritesCount() > 0;
          let o;
    ...
    20687: (t, e, o) => {
      ...
      const T = 'floating-toolbar-react-widgets',
        S = `<div class="tv-floating-toolbar i-closed i-hidden"><div class="tv-floating-toolbar__widget-wrapper"><div class="tv-floating-toolbar__drag js-drag">${C}</div><div class="tv-floating-toolbar__content js-content"></div><div class="${T}"></div></div></div>`;
      class x {
        constructor(t) {
          (this._widget = document.createElement('div')),
            ...
            (this._options = t),
            (this._widget = (0, b.parseHtmlElement)(S)),
    ...
    77209: (t, e, o) => {
      ...
      function W(t) {
        ...
        return i.createElement(x.ToolWidgetIconButton, {
          ...
          onClick: async function () {
            (0, S.trackEvent)('GUI', 'Context action on drawings', 'Settings');
      ...
      function D(t) {
        ...
        const a = r[0].properties().frozen,
          l = (0, E.useProperty)(a),
          c = l
            ? { title: s.t(null, void 0, o(15101)), icon: N }
            : { title: s.t(null, void 0, o(42284)), icon: M };
        return i.createElement(I, {
          className: n,
          isActive: Boolean(l),
          onClick: function () {
            (0, S.trackEvent)('GUI', 'Context action on drawings', 'Lock'),
      ...
      function F(t) {
        ...
        return i.createElement(x.ToolWidgetIconButton, {
          ...
          'data-name': 'remove',
          onClick: function () {
            (0, S.trackEvent)('GUI', 'Context action on drawings', 'Remove'),
      ...
      function K(t) {
        const {
          ...
          [d, h] = (0, i.useState)([]),
          p = (0, i.useRef)(null),
          u = (0, i.useMemo)(() => new Z.ActionsProvider(n), [n]);
        return i.createElement(
          i.Fragment,
          null,
          i.createElement($.KeyboardDocumentListener, {
            keyCode: 27,
            eventType: 'keyup',
            handler: function () {
              (0, _.ensureNotNull)(p.current).close();
            },
          }),
          i.createElement(
            U.ToolWidgetMenu,
            {
              ...
              onOpen: r
                ? void 0
                : function () {
                    const t = [(0, Z.createVisualOrderAction)(n, c)];
                    t.push(
                      (0, Z.createChangeIntervalsVisibilitiesAction)(n, c),
                    );
                    const e = (function () {
                      const t = [],
                        e = O.isMacKeyboard ? ' +' : '',
                      ...
                      i.length > 0 &&
                        t.push(
                          new H.Action({
                            ...
                            icon: o(36296),
                            shortcutHint:
                              O.humanReadableModifiers(z.Modifiers.Mod) +
                              e +
                              ' Drag',
                            label: s.t(null, void 0, o(52977)),
                            onExecute: () => {
                      ...
                      if (
                        ...
                        return t;
                      return (
                        t.push(...(0, Z.createSyncDrawingActions)(n, c)), t
                      );
                    })();
              ...
              onClick: r
                ? function (t) {
                    u.contextMenuActionsForSources(c).then((e) => {
                      window.matchMedia(f.DialogBreakpoints.TabletSmall).matches
                        ? G.ContextMenuManager.showMenu(J(e), t, {
                            mode: 'drawer',
                            'data-name': 'more-menu',
                          })
                        : h(J(e));
                ...
                : void 0,
              title: e,
              content: i.createElement(R.Icon, { icon: Y }),
              'data-name': 'more',
              menuDataName: 'more-menu',
            },
            i.createElement(j.ActionsTable, { parentIsOpened: !0, items: d }),
          ),
        );
      }
      function J(t) {
      ...
      function ot(t) {
        ...
        return i.createElement(
          U.ToolWidgetMenu,
          {
            className: l,
            arrow: !1,
            content: i.createElement(R.Icon, { icon: it(c) }),
            title: r,
            'data-name': t['data-name'],
            menuDataName: `${t['data-name']}-menu`,
          },
          i.createElement(j.ActionsTable, { items: d }),
        );
      }
      function it(t) {
        switch (t) {
      ...
      function st(t) {
        ...
        return i.createElement(
          ...
          i.createElement(j.ActionsTable, { items: l }),
        );
      }
      var rt = o(26867),
        at = o.n(rt);
      o(56337), o(53351);
      class lt extends b.FloatingToolbar {
        constructor(t) {
          super(lt._prepareOptions(t)),
            (this._onWidgetStateChangedDelegate = new (at())()),
            (this._statedWidgets = []),
        ...
        addGroupedWidget(t, e = {}) {
          (0, _.assert)(
            t.states.length > 0 &&
              -1 !== lt._getStateIndexById(t, t.currentStateId),
        ...
        removeGroupedWidget(t) {
          ...
          (0, _.assert)(!1, `Unknown groupId(${t})`);
        }
        ...
        setGroupedWidgetState(t, e) {
          const o = this._ensuredGetWidgetDataForId(t);
          (0, _.assert)(
            -1 !== lt._getStateIndexById(o.statedWidget, e),
            `Unknown stateId (${e})`,
          ),
        ...
        _updateWidgetPreview(t) {
          ...
          t.toolbarWidget.firstChild
            ...
            : (t.toolbarWidget.appendChild(o),
              t.toolbarWidget.appendChild(lt._createCaret()));
        }
        ...
        _onWindowClicked(t) {
          if (
            this.isVisible() &&
            this._currentPopup &&
            !lt._isEventInElement(t, this._currentPopup.element)
          ) {
            for (let e = 0; e < this._statedWidgets.length; ++e)
              if (lt._isEventInElement(t, this._statedWidgets[e].toolbarWidget))
                return;
            this._closePopup();
          }
        }
      ...
      var ct = o(23568),
        ...
        ht = o(23378),
        pt = o(46627);
      const ut = new r.TranslatedString(
          'change line tool(s) font size',
          s.t(null, void 0, o(36819)),
        ),
        _t = new r.TranslatedString(
          'change line tool(s) line style',
          s.t(null, void 0, o(54769)),
        ),
        gt =
          (new r.TranslatedString(
            'apply drawing template',
            s.t(null, void 0, o(49037)),
          ),
          s.t(null, void 0, o(89517))),
        mt = s.t(null, void 0, o(34596)),
        vt = s.t(null, void 0, o(41610)),
        wt = s.t(null, void 0, o(32733)),
        yt = s.t(null, void 0, o(17006));
      class bt {
        constructor(t) {
          (this._isDrawingFinished = new (c())(!0)),
            ...
            (this._emojiToolSpawn = p.emojiTool.spawn()),
        ...
        onSourceChanged(t) {
          ...
          if (
            ...
            this.activeChartWidget().model().model().dataSourceForId(e.id())
              ? (!e.userEditEnabled() ||
                  (!(0, h.isLineDrawnWithPressedButton)(e.toolname) &&
          ...
          return (
            this._propertyApplier ||
              (this._lineToolsDoNotAffectChartInvalidation ||
                (this._lineToolsDoNotAffectChartInvalidation =
                  new pt.FeatureToggleWatchedValue(
                    'do_not_invalidate_chart_on_changing_line_tools',
                    !1,
                  )),
              (this._propertyApplier = new ht.PropertyApplierWithoutSavingChart(
        ...
        _createLineStyleButton(t) {
          ...
          const o = e[0];
          if (!(0, dt.isDataSource)(o)) return !1;
          const i = {
            component: ot,
            props: {
    ...
    59197: (t, e, o) => {
      'use strict';
      var i = o(47539).TranslatedString,
        n = o(77209).LineToolPropertiesWidgetBase;
      const s = o(70114).ColorPickerButton,
        r = o(61259).LineWidthButton;
      var a = o(94071),
        l = o(21065),
        c = o(48984),
        d = new i(
        ...
        _ = o(44352).t(null, void 0, o(40054)),
        g = o(44352).t(null, void 0, o(12928)),
        m = o(44352).t(null, void 0, o(19221)),
        v = o(44352).t(null, void 0, o(21327)),
        w = o(44352).t(null, void 0, o(38455)),
        y = o(44352).t(null, void 0, o(71845)),
        b = o(44352).t(null, void 0, o(32733)),
        f = o(44352).t(null, void 0, o(23886)),
        C = o(44352).t(null, void 0, o(86327)),
        T = o(44352).t(null, void 0, o(47059)),
        S = o(44352).t(null, void 0, o(36785)),
        x = o(44352).t(null, void 0, o(49593)),
        P = o(44352).t(null, void 0, o(67455)),
        W = o(44352).t(null, void 0, o(79964)),
        E = o(44352).t(null, void 0, o(45320));
      class L extends n {
        constructor(t) {
        ...
        showPropertiesOf(t, e, o) {
          ...
          if (
            ...
            for (var n = {}, r = 0; r < i.length; r++) {
              for (
                var a = i[r], l = e, c = a.name.split('.'), d = 0;
                d < c.length;
                ++d
              )
                l = l && l[c[d]];
