(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [92],
  {
    ...
    36719: (e) => {
      e.exports = {
        container: 'container-yBTUFQ8v',
        bottomPadding: 'bottomPadding-yBTUFQ8v',
        centerElement: 'centerElement-yBTUFQ8v',
        notice: 'notice-yBTUFQ8v',
        'notice-showed': 'notice-showed-yBTUFQ8v',
      };
    },
    64388: (e, t, r) => {
      'use strict';
      ...
      function c(e) {
        ...
        return n.createElement(
          n.Fragment,
          null,
          n.createElement('span', { className: a.background }),
          n.createElement(i.Icon, {
            icon: r,
            className: a.icon,
            'aria-hidden': !0,
          }),
          t && n.createElement('span', { className: a['visually-hidden'] }, t),
        );
      }
      const u = (0, n.forwardRef)((e, t) => {
        ...
        return n.createElement(
          'button',
          { ...f, className: s(e), ref: t, type: i },
          n.createElement(c, { icon: o }, r),
        );
      });
      ...
      var l = r(71687),
        f = r(53017);
      (0, n.forwardRef)((e, t) => {
        const { children: r, icon: o, renderComponent: i, ...a } = e,
          u = null != i ? i : l.CustomComponentDefaultLink;
        return n.createElement(
          u,
          {
            ...a,
    ...
    53017: (e, t, r) => {
      ...
      r.d(t, { mergeRefs: () => n, isomorphicRef: () => o });
    },
    81573: (e, t, r) => {
      'use strict';
      r.r(t), r.d(t, { ChartScreenshotHintRenderer: () => R });
      var n = r(50959),
        o = r(962),
        i = r(4889),
        a = r(97754),
      ...
      const h = n.forwardRef((e, t) =>
        n.createElement(c.NavButton, { ...e, ref: t, icon: m(e.size) }),
      );
      var y = r(90186),
        w = r(30162),
        v = r(27941),
        ...
        b = r(38802),
        _ = r.n(b);
      const x = { danger: w, warning: w, success: g, default: v };
      function E(e) {
        const {
          informerIntent: t,
          content: r,
        ...
        return n.createElement(
          'div',
          {
            className: a(_().container, _()[`container-${t}`], o),
              ...
              n.createElement(
                ...
                n.createElement(
                  ...
                  i &&
                    n.createElement(
                      'span',
                      { className: a(_().header, _()[`header-${p}`]) },
                      i,
                    ),
                  ' ',
                  r,
      ...
      function P(e) {
        ...
        return (
          ...
          n.createElement(
            'div',
            { className: a(k.container, e.bottomPadding && k.bottomPadding) },
            n.createElement(
              'div',
              { className: k.centerElement },
              n.createElement(E, {
                content: e.text,
                informerIntent: 'success',
                className: a(k.notice, t && k['notice-showed']),
              }),
            ),
          )
        );
